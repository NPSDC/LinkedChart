...
//linked-charts
!function(t,e){"object"==typeof exports&&"undefined"!=typeof module?e(exports):"function"==typeof define&&define.amd?define(["exports"],e):e(t.lc=t.lc||{})}(this,function(t){"use strict";function e(){var t={};return t.add_property=function(e,n){var r="get_"+e,a={};return t[e]=function(e,n,o){if(void 0===e)return t[r]();if("_override_"==e)a[n]="function"==typeof o?o:function(){return o};else{t[r]="function"==typeof e?e:function(){return e};for(var i in a)t["get_"+i]=a[i]}return t.layers?t:t.chart?t.chart:t},t[r]="function"==typeof n?n:function(){return n},t},t}function n(t){var e={};return function(){return"clear"===arguments[0]?void(e={}):(arguments in Object.keys(e)||0==arguments.length&&0!=Object.keys(e).length||(e[arguments]=t.apply(void 0,arguments)),e[arguments])}}function r(t,e){if("object"!=typeof t)throw"Error in function 'separateBy': first argument is not an object";var n;if(n="undefined"==typeof t.length?"obj":"arr",("number"==typeof e||"string"==typeof e)&&(e=[e]),"undefined"==typeof e.length)throw"Error in function 'separateBy': "+e.toString()+" is not a property name";if(0==e.length)return t;for(var a,o,i={},l=[],a=Object.keys(t),s=0;s<a.length;s++)"undefined"!=typeof t[a[s]][e[0]]&&-1==l.indexOf(t[a[s]][e[0]])&&l.push(t[a[s]][e[0]]);if(0==l.length)return e.shift(),r(t,e);for(var s=0;s<l.length;s++)i[l[s]]="obj"==n?{}:[];for(var s=0;s<a.length;s++)o=t[a[s]][e[0]],"undefined"!=typeof o&&(delete t[a[s]][e[0]],"obj"==n&&(i[o][a[s]]={}),"obj"==n?Object.assign(i[o][a[s]],t[a[s]]):i[o].push(t[a[s]]));if("arr"==n){for(var d=!0,s=0;d&&s<l.length;)d=1==i[l[s]].length,s++;if(d)for(var c,s=0;s<l.length;s++)c={},Object.assign(c,i[l[s]][0]),i[l[s]]={},Object.assign(i[l[s]],c)}e.shift();for(var s=0;s<l.length;s++)i[l[s]]=r(i[l[s]],e.slice());return i}function a(t,e){if(t.length!=e.length)throw"Error in getEuclideanDistance: length of theinput vectors is not the same";for(var n=0,r=0;r<t.length;r++)n+=(t[r]-e[r])*(t[r]-e[r]);return Math.sqrt(n)}function o(t){{var e,n,r,o=null,i=null,l=5;d3.dispatch("click","dblclick")}t.svg.append("rect").attr("class","clickPanel").attr("fill","transparent").lower();var s=t.updateSize;t.updateSize=function(){return s(),t.svg.selectAll(".clickPanel").attr("width",t.get_width()).attr("height",t.get_height()),t};var d=function(){e=d3.mouse(document.body),r=d3.mouse(this),i=window.setTimeout(function(){i=null},1e3);var n=d3.mouse(this);t.svg.append("rect").attr("class","selection").attr("x",n[0]).attr("y",n[1]).attr("width",1).attr("height",1),t.container.select(".inform").classed("blocked",!0)},c=function(){var e=t.svg.select(".selection");if(!e.empty()){var n=d3.mouse(this);e.attr("x",d3.min([n[0],r[0]])).attr("y",d3.min([r[1],n[1]])).attr("width",Math.abs(r[0]-n[0])).attr("height",Math.abs(r[1]-n[1])),d3.selectAll(".tmp-selection.selected").classed("selected",!1);var a=t.findPoints([+e.attr("x")-t.get_margin().left,+e.attr("y")-t.get_margin().top],[+e.attr("x")+ +e.attr("width")-t.get_margin().left,+e.attr("y")+ +e.attr("height")-t.get_margin().top]);"function"==typeof a.empty&&(a=[a]);for(var o=0;o<a.length;o++)a[o].filter(function(){return!d3.select(this).classed("selected")}).classed("selected",!0).classed("tmp-selection",!0).each(function(e){t.svg.select(".col").selectAll(".label").filter(function(t){return t==e.col}).classed("tmp-selection",!0).classed("selected",!0),t.svg.select(".row").selectAll(".label").filter(function(t){return t==e.row}).classed("tmp-selection",!0).classed("selected",!0)})}},u=function(){var r=d3.event.shiftKey;t.container.select(".inform").classed("blocked",!1);var s=1*t.svg.selectAll("rect.selection").attr("x"),d=1*t.svg.selectAll("rect.selection").attr("y"),c=1*t.svg.selectAll("rect.selection").attr("width"),u=1*t.svg.selectAll("rect.selection").attr("height"),g=[s-t.get_margin().left,d-t.get_margin().top],p=[s+c-t.get_margin().left,d+u-t.get_margin().top],f=d3.select(this),_=d3.mouse(this);return t.svg.selectAll("rect.selection").remove(),_[0]=_[0]-t.get_margin().left,_[1]=_[1]-t.get_margin().top,i&&a(e,d3.mouse(document.body))<l?(window.clearTimeout(i),i=null,o&&a(n,d3.mouse(document.body))<l?(window.clearTimeout(o),o=null,f.on("dblclick").apply(f,[r])):o=window.setTimeout(function(){return function(){f.on("click").call(f,_,r),o=null}}(d3.event),300),void(n=d3.mouse(document.body))):(r&&t.mark(t.svg.selectAll(".selected")),t.svg.selectAll(".tmp-selection").classed("tmp-selection",!1).classed("selected",!1),void(r||t.zoom(g,p)))},g=function(e){e?t.mark("__clear__"):t.resetDomain()},p=function(e,n){var r=t.findPoints(e,e);"function"==typeof r.empty&&(r=[r]);for(var a=0;a<r.length&&r[a].empty();)a++;if(a<r.length)if(n)t.mark(r[a]);else{var o=r[a].on("click");o.call(r[a].node(),r[a].datum())}};return t.svg.on("mousedown",d).on("mousemove",c).on("mouseup",u).on("dblclick",g).on("click",p),t}function i(t,e){for(var n=0,r=0,a=0;a<t.length;a++)n+=t[a],r+=e[a];for(var o=n/t.length,i=r/e.length,l=0,s=0,d=0,a=0;a<t.length;a++)l+=(t[a]-o)*(e[a]-i),s+=(t[a]-o)*(t[a]-o),d+=(e[a]-i)*(e[a]-i);return l/Math.sqrt(s*d)}function l(t,e,n,r,a,o){var i=function(t,e){var n=t.split(e);if(""==n[n.length-1]&&n.pop(),1!=n.length){for(var r,a=0,o=0,i=t.length,l=0;l<n.length-1;l++)o+=n[l].length+1,i-=n[l].length+1,o*i>a&&(a=o*i,r=l);return[n.slice(0,r+1).join(e)+e,n.slice(r+1,n.length-r).join(e)]}},l=function(t){for(var e=Array.apply(null,Array(t.length)).map(Number.prototype.valueOf,0),n=["a","A","o","O","e","E","u","U","i","I"],r=0;r<t.length;r++)-1!=n.indexOf(t[r])&&(e[r]=1);for(var r=0;r<e.length-1;r++)e[r]=(e[r]-e[r+1])*e[r];if(e[e.length-1]=0,e[e.length-2]=0,-1==e.indexOf(1))return[t.substring(0,Math.ceil(t.length/2))+"-",t.substring(Math.ceil(t.length/2))];for(var a,o=0,r=0;r<t.length;r++)1==e[r]&&o<(r+2)*(t.length-r-1)&&(o=(r+2)*(t.length-r-1),a=r);return[t.substring(0,a+1)+"-",t.substring(a+1)]};"undefined"==typeof r&&(r=8),"undefined"==typeof a&&(a=13),"undefined"==typeof o&&(o=.6);for(var s,d=d3.min([n,a]),c=[t],u=t.length,g=0;u*d*o>e&&d>=r;)if(1==u)d=e/o*.95;else if(n/(c.length+1)<e/(u*o)*.95)d=e/(u*o)*.95;else{for(var p,f=[" ",".",",","/","\\","-","_","+","*","&","(",")","?","!"],_=0;"undefined"==typeof p&&_<f.length;)p=i(c[g],f[_]),_++;"undefined"==typeof p&&(p=l(c[g])),c.splice(g,1,p[0],p[1]),s=Math.floor(e/(d*o));for(var _=0;_<c.length-1;_++)c[_].length+c[_+1].length<=s&&c[_].length+c[_+1].length<u&&(c.splice(_,2,c[_]+c[_+1]),d=d3.min([n/(c.length-1),a]),s=Math.floor(e/(d*o)));d=d3.min([n/c.length,a]),u=c[0].length,g=0;for(var _=1;_<c.length;_++)c[_].length>u&&(u=c[_].length,g=_)}return{spans:c,fontSize:d}}function s(t,e,n,r,a,o,i){var s=l(r,e,n,a,o,i),d=t.selectAll("text").data(d3.range(s.spans.length));d.exit().remove(),d.enter().append("text").merge(d).attr("class","plainText").attr("text-anchor","left").attr("font-size",s.fontSize).attr("y",function(t){return(t+1)*s.fontSize}).text(function(t){return s.spans[t]})}function d(t){var n=e().add_property("npoints").add_property("dataIds").add_property("pointMouseOver",function(){}).add_property("pointMouseOut",function(){}).add_property("on_click",function(){}).add_property("layerDomainX").add_property("layerDomainY").add_property("contScaleX",!0).add_property("contScaleY",!0).add_property("colour",function(t){return n.colourScale(n.get_colourValue(t))}).add_property("addColourScaleToLegend",!0).add_property("palette").add_property("colourRange").add_property("colourValue",void 0).add_property("dresser",function(){});return n.id=t,n.dataIds("_override_","npoints",function(){return n.get_dataIds().length}),n.npoints("_override_","dataIds",function(){return d3.range(n.get_npoints())}),n.colour("_override_","addColourScaleToLegend",!1),n.colourRange(function(){var t=n.get_dataIds();if(void 0!==n.get_colourValue(t[0])){for(var e=[],r=0;r<t.length;r++)-1==e.indexOf(n.get_colourValue(t[r]))&&e.push(n.get_colourValue(t[r]));return e}}),n.colourScale=function(){return"black"},n.resetColourScale=function(){var t=n.get_colourRange();if(void 0!==t){for(var e=!0,r=0;r<t.length;r++)e=e&&"number"==typeof t[r];if(e&&t.sort(function(t,e){return t-e}),e)if("undefined"==typeof n.get_palette()&&n.palette(d3.interpolateSpectral?d3.interpolateSpectral:["red","yellow","green","blue"]),n.get_palette().splice){var a=n.get_palette();if(a.length!=t.length&&(t=[d3.min(t),d3.max(t)]),1==a.length&&a.push(a[0]),a.length>t.length){for(var o=[],r=0;r<a.length;r++)o.push(t[0]+r*(t[1]-t[0])/(a.length-1));t=o}n.colourValueScale=d3.scaleLinear().domain(t).range(a),n.colourScale=function(t){return n.colourValueScale(t)}}else{t=[d3.min(t),d3.max(t)];var i=[0,1];n.get_palette().domain&&(i=n.get_palette().domain()),n.colourValueScale=d3.scaleLinear().domain(t).range(i),n.colourScale=function(t){return n.get_palette(n.colourValueScale(t))}}else if("undefined"==typeof n.get_palette()&&n.palette(["#000"].concat(d3.schemeCategory10)),n.get_palette().length){for(var a=n.get_palette(),l=a.length,r=0;r<t.length-l;r++)a.push(a[r%l]);n.colourValueScale=d3.scaleOrdinal().domain(t).range(a),n.colourScale=function(t){return n.colourValueScale(t)}}else{var i=[0,1];n.get_palette().domain&&(i=n.get_palette().domain()),n.colourValueScale=d3.scalePoint().domain(t).range(i),n.colourScale=function(t){return n.get_palette(n.colourValueScale(t))}}n.colourScale.domain=n.get_colourRange,n.chart.showLegend()&&n.addLegend(n.colourScale,"colour",n.id)}},n.legendBloccks=[],n.addLegend=function(t,e,r){return n.chart.legend.add(t,e,r,n),n.legendBloccks.push(r),n},n.update=function(){return n.updatePoints(),n.updatePointStyle(),n.updatePointLocation(),n},n.put_static_content=function(){n.g=n.chart.svg.append("g").attr("class","chart_g").attr("id",n.id).attr("clip-path","url(#viewBox)")},n.afterUpdate=function(){},n.updateSize=function(){return"undefined"!=typeof n.chart.transition?(n.g.transition(n.chart.transition).attr("transform","translate("+n.chart.get_margin().left+", "+n.chart.get_margin().top+")"),n.g.selectAll(".data_point")):n.g.attr("transform","translate("+n.chart.get_margin().left+", "+n.chart.get_margin().top+")"),n},n.updatePoints=function(){},n.updatePointStyle=function(){return n.resetColourScale(),n.get_dresser(n.g.selectAll(".data_point")),n},n.updatePointLocation=function(){},n.findPoints=function(){return n.g.select("___")},n}function c(t){var n=e().add_property("width",function(){return t.margin().right}).add_property("height",function(){return t.plotHeight()}).add_property("x",function(){return t.plotWidth()+t.margin().left}).add_property("y",function(){return t.margin().top}).add_property("alignX").add_property("alignY");return n.blocks={},n.chart=t,n.add=function(t,e,r,a){n.chart.set_margin({right:d3.max([75,n.chart.margin().right])});var o={};if(o.scale="function"==typeof t?t:function(){return t},"undefined"!=typeof a&&(o.layer=a),-1==["colour","size","style"].indexOf(e))throw"Error in 'legend.add': "+e+" is not a suitable type of legend block. Please, use one of these: 'colour', 'size', 'style'";return o.type=e,n.blocks[r]=o,n.chart},n.convertScale=function(t){var e,r;try{e=n.blocks[t].scale()}catch(a){e=n.blocks[t].scale}if("function"!=typeof e&&"undefined"==typeof e.splice&&(e=n.blocks[t].scale),"function"!=typeof e){var o=!1,i=!1;if(1==e.length)throw"Error in 'legend.add': range of the scale is not defined.";2==e[0].length&&"number"==typeof e[0][0]&&"number"==typeof e[0][1]&&(o=!0),"colour"==n.blocks[t].type&&e[0].length!=e[1].length&&(i=!0),2==e[1].length&&"number"==typeof e[0][0]&&"number"==typeof e[0][1]&&(i=!0),o&&i&&(r=d3.scaleLinear().domain(e[0]).range(e[1]),r.steps=e.steps?e.steps:9),o&&!i&&(r=d3.scaleQuantize().domain(e[0]).range(e[1]),r.steps=e[1].length),!o&&i&&(r=d3.scalePoint().domain(e[0]).range(e[1]),r.steps=e[0].length),o||i||(e[0].length>e[1].length&&e[0].splice(e[1].length),e[1].length>e[0].length&&e[1].splice(e[0].length),r=d3.scaleOrdinal().domain(e[0]).range(e[1]),r.steps=e[0].length),n.blocks[t].domain=e[0]}else{if("function"!=typeof e)throw"Error in 'legend.add': the type of scale argument is not suported. Scale should be an array or a function.";var l;if(l="function"==typeof e.domain?e.domain():e.domain,"undefined"==typeof l)throw"Error in 'legend.add': the domain of the scale is not defined.";n.blocks[t].domain=l,r=e,r.steps=e.steps?e.steps:2==l.length?9:l.length}return r},n.remove=function(t){if("undefined"==typeof n.blocks[t])throw"Error in 'legend.remove': block with ID "+t+" doesn't exist";return"undefined"!=typeof n.blocks[t].layer&&n.blocks[t].layer.legendBlocks.splice(n.blocks[t].layer.legendBlocks.indexOf(t),1),delete n.blocks[t],n.g.select("#"+t).remove(),n.update(),n.chart},n.rename=function(t,e){return n.blocks[e]=legendBlocks.blocks[t],delete n.blocks[t],"undefined"!=typeof n.blocks[e].layer&&n.blocks[e].layer.legendBlocks.splice(n.blocks[e].layer.legendBlocks.indexOf(t),1,e),n.g.select("#"+t).attr("id",e),n.update(),n.chart},n.updateGrid=function(){for(var t,e,r,a,o=Object.keys(n.blocks).length,i=n.width()*n.height(),l=1;l<=Math.floor(Math.sqrt(o));l++)e=Math.ceil(o/l),r=d3.min([n.height()/l,2*n.width()/e]),a=d3.min([r/2,n.width()/e]),i>n.height()*n.width()-r*a*o&&(i=n.height()*n.width()-r*a*o,t=[l,e]);a=n.width()/t[1],r=n.height()/t[0];var s=0,d=0;for(var l in n.blocks)n.blocks[l].width=a,n.blocks[l].height=r,n.blocks[l].x=d*a,n.blocks[l].y=s*r,d++,d==t[1]&&(d=0,s++)},n.updateBlock=function(t){var e=n.convertScale(t);if(n.blocks[t].height=d3.min([n.blocks[t].height,20*e.steps]),"undefined"==typeof n.blocks[t])throw"Error in 'legend.updateBlock': block with ID "+t+" is not defined.";var r=n.g.select("#"+t);r.empty()&&(r=n.g.append("g").attr("id",t)),r.attr("transform","translate("+n.blocks[t].x+", "+n.blocks[t].y+")");var a=r.select(".title");a.empty()&&(a=r.append("g").attr("class","title")),s(a,n.blocks[t].height,.2*n.blocks[t].width,t),a.attr("transform","rotate(-90)translate(-"+n.blocks[t].height+", 0)");var o;o=n.blocks[t].domain.length==e.steps?n.blocks[t].domain:d3.range(e.steps).map(function(r){return n.blocks[t].domain[0]+r*(n.blocks[t].domain[1]-n.blocks[t].domain[0])/(e.steps-1)});for(var i=[],l=0;l<o.length;l++)i.push([o[l]]);var d=r.selectAll(".sample").data(i);if(d.exit().remove(),d.enter().append("g").attr("class","sample").merge(d).attr("transform",function(r,a){return"translate("+.2*n.blocks[t].width+", "+a*n.blocks[t].height/e.steps+")"}),"colour"==n.blocks[t].type){var c=r.selectAll(".sample").selectAll("rect").data(function(t){return t});c.enter().append("rect").merge(c).attr("width",d3.min([.2*n.blocks[t].width,20])).attr("height",n.blocks[t].height/e.steps).attr("fill",function(t){return e(t)});var u=r.selectAll(".sample").selectAll("g").data(function(t){return"number"==typeof t[0]?[t[0].toString()]:t});u.enter().append("g").merge(u).attr("transform","translate("+.25*n.blocks[t].width+", 0)"),r.selectAll(".sample").selectAll("g").each(function(r){s(d3.select(this),.55*n.blocks[t].width,n.blocks[t].height/e.steps,r)})}"size"==n.blocks[t].type},n.update=function(){n.g.attr("transform","translate("+n.x()+", "+n.y()+")"),n.updateGrid();for(var t in n.blocks)n.updateBlock(t);return n.chart},n}function u(){var t=e().add_property("width",500).add_property("height",500).add_property("plotWidth",440).add_property("plotHeight",440).add_property("margin",{top:15,right:10,bottom:50,left:50}).add_property("title","").add_property("titleX",function(){return t.width()/2}).add_property("titleY",function(){return d3.min([17,.9*t.margin().top])}).add_property("titleSize",function(){return d3.min([15,.8*t.margin().top])}).add_property("transitionDuration",1e3).add_property("markedUpdated",function(){});return t.transition=void 0,t.width("_override_","plotWidth",function(){return t.get_width()-(t.get_margin().right+t.get_margin().left)}),t.margin("_override_","plotWidth",function(){return t.get_width()-(t.get_margin().right+t.get_margin().left)}),t.height("_override_","plotHeight",function(){return t.get_height()-(t.get_margin().top+t.get_margin().bottom)}),t.margin("_override_","plotHeight",function(){return t.get_height()-(t.get_margin().top+t.get_margin().bottom)}),t.set_margin=function(e){return"undefined"==typeof e.top&&(e.top=t.margin().top),"undefined"==typeof e.bottom&&(e.bottom=t.margin().bottom),"undefined"==typeof e.left&&(e.left=t.margin().left),"undefined"==typeof e.right&&(e.right=t.margin().right),t.margin(e),t},t.put_static_content=function(e){t.container=e.append("div"),t.container.node().ondragstart=function(){return!1},t.svg=t.container.append("svg"),t.viewBox=t.svg.append("defs").append("clipPath").attr("id","viewBox").append("rect"),t.container.append("div").attr("class","inform hidden").append("p").attr("class","value"),t.svg.append("text").attr("class","title plainText").attr("text-anchor","middle")},t.defineTransition=function(){t.transition=d3.transition().duration(t.transitionDuration()),t.transition.on("end",t.defineTransition)},t.mark=function(e){return"__clear__"==e?(t.svg.selectAll(".data_point.marked").classed("marked",!1),void t.svg.selectAll(".data_point").attr("opacity",1)):(t.svg.selectAll(".data_point.marked").empty()&&t.svg.selectAll(".data_point").attr("opacity",.5),e.classed("switch",!0),e.size()<2&&e.filter(function(){return d3.select(this).classed("marked")}).classed("switch",!1).classed("marked",!1).attr("opacity",.5),e.filter(function(){return d3.select(this).classed("switch")}).classed("marked",!0).classed("switch",!1).attr("opacity",1),t.svg.selectAll(".data_point.marked").empty()&&t.svg.selectAll(".data_point").attr("opacity",1),void t.markedUpdated())},t.afterUpdate=function(){0!=t.get_transitionDuration()&&t.defineTransition()},t.place=function(e){if(void 0===e&&(e="body"),"string"==typeof e){var n=e;if(e=d3.select(n),0==e.size())throw"Error in function 'place': DOM selection for string '"+n+"' did not find a node."}return t.put_static_content(e),t.update(),t.afterUpdate(),t},t.updateSize=function(){return t.viewBox.attr("x",-5).attr("y",-5).attr("width",t.get_plotWidth()+10).attr("height",t.get_plotHeight()+10),"undefined"!=typeof t.transition?(t.svg.transition(t.transition).attr("width",t.get_width()).attr("height",t.get_height()),t.container.transition(t.transition).style("width",t.get_width()+"px").style("height",t.get_height()+"px"),t.svg.select(".title").transition(t.transition).attr("font-size",t.titleSize()).attr("x",t.titleX()).attr("y",t.titleY())):(t.svg.attr("width",t.get_width()).attr("height",t.get_height()),t.container.style("width",t.get_width()+"px").style("height",t.get_height()+"px"),t.svg.select(".title").attr("font-size",t.titleSize()).attr("x",t.titleX()).attr("y",t.titleY())),t},t.updateTitle=function(){t.svg.select(".title").text(t.title())},t.update=function(){return t.updateSize(),t.updateTitle(),t},t}function g(){var t=u().add_property("activeLayer",void 0).add_property("showLegend",!0);t.legend=c(t),t.layers={};var e=function(e){return function(){if(t.get_activeLayer()[e])return t.get_activeLayer()[e].apply(t,arguments);for(var n in t.layers)if(t.layers[n][e])return t.layers[n][e].apply(t,arguments)}};t.syncProperties=function(n){for(var r in n)"undefined"==typeof t[r]&&(t[r]=e(r))},t.get_nlayers=function(){return Object.keys(t.layers).length},t.get_layer=function(e){return t.layers[e]},t.add_layer=function(e){"undefined"==typeof e&&(e="layer"+t.get_nlayers());var n=d(e);return n.chart=t,t.layers[e]=n,t.activeLayer(t.get_layer(e)),t},t.findPoints=function(e,n){var r=[];return t.svg.selectAll(".chart_g").each(function(){r.unshift(t.get_layer(d3.select(this).attr("id")).findPoints(e,n))}),r},t.placeLayer=function(e){t.get_layer(e).put_static_content(),t.get_layer(e).updateSize(),t.get_layer(e).update()};var n=t.put_static_content;t.put_static_content=function(e){n(e),o(t),t.legend.g=t.svg.append("g");for(var r in t.layers)t.get_layer(r).put_static_content()};var r=t.update;t.update=function(){for(var e in t.layers)t.get_layer(e).updatePoints(),t.get_layer(e).updatePointStyle();return r(),t.showLegend()&&Object.keys(t.legend.blocks).length>0&&t.legend.update(),t};var a=t.afterUpdate;t.afterUpdate=function(){a();for(var e in t.layers)t.get_layer(e).afterUpdate()};var i=t.updateSize;return t.updateSize=function(){i();for(var e in t.layers)t.get_layer(e).updateSize()},t}function p(){function t(t,e,n){var r=(t.range()[1]-t.range()[0])/(t.domain()[1]-t.domain()[0]),a=(e.range()[1]-e.range()[0])/(e.domain()[1]-e.domain()[0]),o=Math.abs(r/a);if(o>n){var i=t.domain()[1]-t.domain()[0],l=i*(o/n-1)/2;t.domain([t.domain()[0]-l,t.domain()[1]+l])}else{var i=e.domain()[1]-e.domain()[0],l=i*(n/o-1)/2;e.domain([e.domain()[0]-l,e.domain()[1]+l])}}var e=g();e.add_property("singleScaleX",!0).add_property("singleScaleY",!0).add_property("domainX").add_property("domainY").add_property("aspectRatio",null).add_property("labelX").add_property("labelY").add_property("ticksX",void 0).add_property("ticksY",void 0),e.axes={};var n=function(t){return function(){var n;if(e["get_singleScale"+t]()){var r=!0;for(var a in e.layers)r=r&&e.get_layer(a)["get_contScale"+t]();if(r)for(var a in e.layers)"undefined"!=typeof e.get_layer(a)["get_layerDomain"+t]()&&("undefined"==typeof n?n=e.get_layer(a)["get_layerDomain"+t]():(n[0]=d3.min([n[0],e.get_layer(a)["get_layerDomain"+t]()[0]]),n[1]=d3.max([n[1],e.get_layer(a)["get_layerDomain"+t]()[1]])));else for(var a in e.layers)"undefined"!=typeof e.get_layer(a)["get_layerDomain"+t]()&&(n="undefined"==typeof n?e.get_layer(a)["get_layerDomain"+t]():n.concat(e.get_layer(a)["get_layerDomain"+t]().filter(function(t){return n.indexOf(t)<0})))}return n}};e.get_domainX=n("X"),e.get_domainY=n("Y"),e.domainX=function(t){return"reset"==t?(e.domainX(e.origDomainX),e):("function"==typeof t&&(e.get_domainX=t),t.splice&&(e.get_domainX=function(){return t}),e)},e.domainY=function(t){return"reset"==t?(e.domainY(e.origDomainY),e):("function"==typeof t&&(e.get_domainY=t),t.splice&&(e.get_domainY=function(){return t}),e)},e.zoom=function(t,n){t[0]!=n[0]&&t[1]!=n[1]&&(e.domainX([e.axes.scale_x.invert(t[0]),e.axes.scale_x.invert(n[0])]),e.domainY([e.axes.scale_y.invert(n[1]),e.axes.scale_y.invert(t[1])]),e.updateAxes())},e.resetDomain=function(){e.domainX("reset"),e.domainY("reset"),e.updateAxes()};var r=e.put_static_content;e.put_static_content=function(t){r(t);var n=e.svg.append("g").attr("class","axes_g");e.axes.x_g=n.append("g").attr("class","x axis"),e.axes.x_label=e.axes.x_g.append("text").attr("class","label").attr("y",-6).style("text-anchor","end"),e.axes.y_g=n.append("g").attr("class","y axis"),e.axes.y_label=e.axes.y_g.append("text").attr("class","label").attr("transform","rotate(-90)").attr("y",6).attr("dy",".71em").style("text-anchor","end");var a=e.get_domainX();e.axes.scale_x=2==a.length&&"number"==typeof a[0]?d3.scaleLinear().nice():d3.scalePoint().padding(.3),e.origDomainX=e.get_domainX;var o=e.get_domainY();e.axes.scale_y=2==o.length&&"number"==typeof o[0]?d3.scaleLinear().nice():d3.scalePoint().padding(.3),e.origDomainY=e.get_domainY};var a=e.updateSize;e.updateSize=function(){return a(),"undefined"!=typeof e.transition?(e.svg.select(".axes_g").transition(e.transition).attr("transform","translate("+e.get_margin().left+", "+e.get_margin().top+")"),e.axes.x_g.transition(e.transition).attr("transform","translate(0,"+e.get_plotHeight()+")"),e.axes.x_label.transition(e.transition).attr("x",e.get_plotWidth())):(e.svg.select(".axes_g").attr("transform","translate("+e.get_margin().left+", "+e.get_margin().top+")"),e.axes.x_g.attr("transform","translate(0,"+e.get_plotHeight()+")"),e.axes.x_label.attr("x",e.get_plotWidth())),e.axes.scale_x.range([0,e.get_plotWidth()]),e.axes.scale_y.range([e.get_plotHeight(),0]),e.updateAxes(),e};var o=function(t){var n={tickValues:null,tickFormat:null},r=e["ticks"+t]();if(r){if("undefined"==typeof r.splice)throw"Error in 'get_ticks': new tick values and labels should be passed as an array";"undefined"==typeof r[0].splice&&(r=[r]);for(var a=1;a<r.length;a++)if(r[0].length!=r[a].length)throw"Error in 'get_ticks': the amount of tick labels must be equal to the amount of tick values";if(n.tickValues=r[0],1==r.length)return n;for(var a,o=r.length>2,i=1;o&&i<r.length-1;){for(a=0;o&&a<r[i].length;)o=r[i][a]==r[i+1][a],a++;i++}o&&r.splice(2);var l,s=[];if(r.length>2)for(var a=0;a<r[0].length;a++){l="";for(var i=1;i<r.length;i++)l+="<tspan x = 0.5 dy = 1.1em",l+=r.colour?" fill = '"+r.colour[i-1]+"'>":">",l+=r[i][a]+"</tspan>";s.push(l)}else s=r[1];n.tickFormat=function(t){return s[n.tickValues.indexOf(t)]}}return n};return e.updateAxes=function(){e.axes.x_label.text(e.get_labelX()),e.axes.y_label.text(e.get_labelY()),e.axes.scale_x.domain(e.get_domainX()),e.axes.scale_y.domain(e.get_domainY()),e.aspectRatio()&&t(e.axes.scale_x,e.axes.scale_y,e.get_aspectRatio());var n=o("X"),r=o("Y");"undefined"!=typeof e.transition?(d3.axisBottom().scale(e.axes.scale_x).tickValues(n.tickValues).tickFormat(n.tickFormat)(e.axes.x_g.transition(e.transition)),d3.axisLeft().scale(e.axes.scale_y).tickValues(r.tickValues).tickFormat(r.tickFormat)(e.axes.y_g.transition(e.transition))):(d3.axisBottom().tickValues(n.tickValues).tickFormat(n.tickFormat).scale(e.axes.scale_x)(e.axes.x_g),d3.axisLeft().scale(e.axes.scale_y).tickValues(r.tickValues).tickFormat(r.tickFormat)(e.axes.y_g));var a=function(){e.axes.x_g.selectAll(".tick").selectAll("text").html(n.tickFormat)};n.tickFormat&&(e.transition?setTimeout(a,e.transition.duration()):a());var i=function(){e.axes.y_g.selectAll(".tick").selectAll("text").html(n.tickFormat)};r.tickFormat&&(e.transition?setTimeout(i,e.transition.duration()):i());for(var l in e.layers)e.get_layer(l).updatePointLocation();return e},e}function f(t,e){void 0===e&&(e=p()),void 0===t&&(t="layer"+e.get_nlayers());var n=e.add_layer(t).get_layer(t).add_property("x").add_property("y").add_property("size",4).add_property("groupName",function(t){return t});return e.syncProperties(n),n.npoints(function(){for(var t,e=0;1e4>e;e++){try{t=n.get_x(e)}catch(r){return e>0?e-1:0}if(void 0===t)return e>0?e-1:0}throw"There seem to be very many data points. Please supply a number via 'npoints'."}),n.pointMouseOver(function(t){d3.select(this).attr("fill",function(t){return d3.rgb(n.get_colour(t)).darker(.5)}).classed("hover",!0),n.chart.container.select(".inform").style("left",d3.event.pageX+10+"px").style("top",d3.event.pageY-10+"px").select(".value").html("ID: <b>"+t+"</b>;<br>x = "+n.get_x(t).toFixed(2)+";<br>y = "+n.get_y(t).toFixed(2)),n.chart.container.select(".inform").classed("hidden",!1)}),n.pointMouseOut(function(){d3.select(this).attr("fill",function(t){return n.get_colour(t)}).classed("hover",!1),n.chart.container.select(".inform").classed("hidden",!0)}),n.findPoints=function(t,e){return n.g.selectAll(".data_point").filter(function(r){var a=[n.chart.axes.scale_x(n.chart.get_x(r)),n.chart.axes.scale_y(n.get_y(r))];return a[0]-n.get_size(r)<=e[0]&&a[1]-n.get_size(r)<=e[1]&&a[0]+n.get_size(r)>=t[0]&&a[1]+n.get_size(r)>=t[1]})},n.layerDomainX(function(){return n.get_contScaleX()?d3.extent(n.get_dataIds(),function(t){return n.get_x(t)}):n.get_dataIds().map(function(t){return n.get_x(t)})}),n.layerDomainY(function(){return n.get_contScaleY()?d3.extent(n.get_dataIds(),function(t){return n.get_y(t)}):n.get_dataIds().map(function(t){return n.get_y(t)})}),n.updatePointLocation=function(){return"undefined"!=typeof n.chart.transition?n.g.selectAll(".data_point").transition(n.chart.transition).attr("cx",function(t){return n.chart.axes.scale_x(n.get_x(t))}).attr("cy",function(t){return n.chart.axes.scale_y(n.get_y(t))}):n.g.selectAll(".data_point").attr("cx",function(t){return n.chart.axes.scale_x(n.get_x(t))}).attr("cy",function(t){return n.chart.axes.scale_y(n.get_y(t))}),n},n.updateSelPointStyle=function(t){if("undefined"==typeof t.length&&(t=[t]),"undefined"!=typeof n.chart.transition)for(var r=0;r<t.length;r++)n.g.select("#p"+t[r]).transition(e.layer.transition).attr("r",function(t){return n.get_size(t)}).attr("fill",function(t){return n.get_colour(t)}).attr("style",function(t){return n.get_style(t)});else for(var r=0;r<t.length;r++)n.g.select("#p"+t[r]).attr("r",n.get_size(t[r])).attr("fill",n.get_colour(t[r])).attr("style",n.get_style(t[r]));return n},n.dresser(function(t){t.attr("fill",function(t){return n.get_colour(t)}).attr("r",function(t){return n.get_size(t)})}),n.updatePoints=function(){var t=n.g.selectAll(".data_point").data(n.get_dataIds(),function(t){return t});t.exit().remove(),t.enter().append("circle").attr("class","data_point").merge(t).on("click",n.get_on_click).on("mouseover",n.get_pointMouseOver).on("mouseout",n.get_pointMouseOut)},e}function _(t,e){void 0===e&&(e=p()),void 0===t&&(t="layer"+e.get_nlayers());var n=e.add_layer(t).get_layer(t).add_property("lineFun").add_property("lineStepNum",100).add_property("lineWidth",1.5);return e.syncProperties(n),n.updatePoints=function(){var t=n.g.selectAll(".data_point").data(n.get_dataIds(),function(t){return t});t.exit().remove(),t.enter().append("path").attr("class","data_point").attr("fill","none").merge(t).on("click",n.get_on_click).on("mouseover",n.get_pointMouseOver).on("mouseout",n.get_pointMouseOut)},n.dresser(function(t){t.attr("stroke",function(t){return n.get_colour(t)}).attr("stroke-width",function(t){return n.get_lineWidth(t)})}),n.updatePointLocation=function(){var t=(n.chart.axes.scale_x.domain()[1]-n.chart.axes.scale_x.domain()[0])/n.get_lineStepNum(),e=function(e){for(var r=[],a=n.chart.axes.scale_x.domain()[0];a<n.chart.axes.scale_x.domain()[1];a+=t)r.push({x:a,y:n.get_lineFun(e,a)});var o=d3.line().x(function(t){return n.chart.axes.scale_x(t.x)}).y(function(t){return n.chart.axes.scale_y(t.y)});return o(r)};"undefined"!=typeof n.chart.transition?n.g.selectAll(".data_point").transition(n.chart.transition).attr("d",e):n.g.selectAll(".data_point").attr("d",e)},n}function h(t,e){var e=u().add_property("nrows").add_property("ncols");e.add_property("colLabels",function(t){return t}).add_property("rowLabels",function(t){return t}).add_property("colIds",function(){return void 0}).add_property("rowIds",function(){return void 0}).add_property("dispColIds",function(){return e.get_colIds()}).add_property("dispRowIds",function(){return e.get_rowIds()}).add_property("heatmapRow",function(t){return e.get_dispRowIds().indexOf(t)}).add_property("heatmapCol",function(t){return e.get_dispColIds().indexOf(t)}).add_property("value").add_property("colour",function(t){return e.colourScale(t)}).add_property("palette",d3.interpolateOrRd).add_property("colourRange",function(){return e.dataRange()}).add_property("clusterRowMetric",a).add_property("clusterColMetric",a).add_property("on_click",function(){}).add_property("rowTitle","").add_property("showValue",!1).add_property("colTitle","").add_property("showLegend",!0).add_property("informText",function(t,n){return"Row: <b>"+t+"</b>;<br>Col: <b>"+n+"</b>;<br>value = "+e.get_value(t,n).toFixed(2)}),e.margin({top:100,left:100,right:10,bottom:40}),e.ncols("_override_","colIds",function(){return d3.range(e.get_ncols())}),e.nrows("_override_","rowIds",function(){return d3.range(e.get_nrows())}),e.rowIds("_override_","nrows",function(){return e.get_rowIds().length}),e.colIds("_override_","ncols",function(){return e.get_colIds().length}),e.axes={};var n=e.put_static_content;e.put_static_content=function(t){n(t),o(e),e.svg.append("g").attr("class","row label_panel"),e.svg.append("g").attr("class","col label_panel"),e.g=e.svg.append("g").attr("class","chart_g").attr("clip-path","url(#viewBox)"),e.text=e.g.append("g").attr("class","text_g"),e.axes.x_label=e.svg.append("text").attr("class","axisLabel").attr("text-anchor","end"),e.axes.y_label=e.svg.append("text").attr("class","axisLabel").attr("text-anchor","end").attr("transform","rotate(-90)"),e.svg.append("g").attr("class","legend_panel")},e.findPoints=function(t,n){var r=e.g.selectAll(".data_point").filter(function(){var r=[this.x.baseVal.value,this.y.baseVal.value];return r[0]<=n[0]&&r[1]<=n[1]&&r[0]+e.cellSize.width>=t[0]&&r[1]+e.cellSize.height>=t[1]});return r.empty()?(t[0]*t[1]<0&&n[0]*n[1]<0&&(r=t[0]<0?e.svg.select(".row").selectAll(".label").filter(function(){
var r=1*d3.select(this).attr("dy");return t[1]>=r-e.cellSize.height&&n[1]<=r}):e.svg.select(".col").selectAll(".label").filter(function(){var r=1*d3.select(this).attr("dy");return t[0]>=r-e.cellSize.width&&n[0]<=r})),r):r},e.dataRange=function(){var t,n,r=0,a=e.get_rowIds(),o=e.get_colIds();do n=d3.extent(o,function(t){return e.get_value(a[r],t)}),"undefined"==typeof t&&(t=n),n[0]<t[0]&&(t[0]=n[0]),n[1]>t[1]&&(t[1]=n[1]),r++;while(r<e.get_nrows());return t},e.labelMouseOver=function(){d3.select(this).classed("hover",!0)},e.labelMouseOut=function(){d3.select(this).classed("hover",!1)},e.reorderRow=function(t){if("flip"==t)return e.get_heatmapRow("__flip__"),e.updateLabelPosition(),e;e.svg.select(".col").selectAll(".label").classed("selected",!1).classed("sorted",!1);var n,r=e.get_rowIds().slice();return r=r.sort(t),e.heatmapRow(function(a){if("__flip__"==a)return void(r=r.reverse());if("__order__"==a)return r.sort(t);var o=e.get_dispRowIds(),i=r.filter(function(t){return-1!=o.indexOf(t)});if(i.length!=o.length&&(i=o.sort(t),r=i.slice()),n=i.indexOf(a),n>-1)return n;throw"Wrong rowId in chart.get_heatmapRow"}),e.updateLabelPosition(),e},e.reorderCol=function(t){if("flip"==t)return e.get_heatmapCol("__flip__"),e.updateLabelPosition(),e;e.svg.select(".row").selectAll(".label").classed("selected",!1).classed("sorted",!1);var n,r=e.get_colIds().slice();return r=r.sort(t),e.heatmapCol(function(a){if("__flip__"==a)return void(r=r.reverse());if("__order__"==a)return r.sort(t);var o=e.get_dispColIds(),i=r.filter(function(t){return-1!=o.indexOf(t)});if(i.length!=o.length&&(i=o.sort(t),r=i.slice()),n=i.indexOf(a),n>-1)return n;throw"Wrong rowId in chart.get_heatmapRow"}),e.updateLabelPosition(),e};var r=e.updateSize;return e.updateSize=function(){return r(),"undefined"!=typeof e.transition?(e.svg.selectAll(".label_panel").transition(e.transition).attr("transform","translate("+e.get_margin().left+", "+e.get_margin().top+")"),e.svg.select(".legend_panel").transition(e.transition).attr("transform","translate(0, "+(e.get_margin().top+e.get_plotHeight())+")"),e.g.transition(e.transition).attr("transform","translate("+e.get_margin().left+", "+e.get_margin().top+")"),e.axes.x_label.transition(e.transition).attr("font-size",d3.min([e.get_margin().bottom-2,15])).attr("x",e.get_plotWidth()+e.get_margin().left).attr("y",e.get_height()),e.axes.y_label.transition(e.transition).attr("font-size",d3.min([e.get_margin().right-2,15])).attr("x",-e.get_margin().top).attr("y",e.get_width())):(e.svg.selectAll(".label_panel").attr("transform","translate("+e.get_margin().left+", "+e.get_margin().top+")"),e.svg.select(".legend_panel").attr("transform","translate(0, "+(e.get_margin().top+e.get_plotHeight())+")"),e.g.attr("transform","translate("+e.get_margin().left+", "+e.get_margin().top+")"),e.axes.x_label.attr("font-size",d3.min([e.get_margin().bottom-2,15])).attr("x",e.get_plotWidth()+e.get_margin().left).attr("y",e.get_height()),e.axes.y_label.attr("font-size",d3.min([e.get_margin().right-2,15])).attr("x",-e.get_margin().top).attr("y",e.get_width())),e.updateLegendSize(),e.updateLabelPosition(),e},e.updateLabelPosition=function(){var t=e.get_dispColIds().length,n=e.get_dispRowIds().length;return e.cellSize={width:e.get_plotWidth()/t,height:e.get_plotHeight()/n},e.axes.scale_x=d3.scaleLinear().domain([0,t-1]).range([0,e.get_plotWidth()-e.cellSize.width]).nice(),e.axes.scale_y=d3.scaleLinear().domain([0,n-1]).range([0,e.get_plotHeight()-e.cellSize.height]).nice(),"undefined"!=typeof e.transition?(e.svg.select(".col").selectAll(".label").transition(e.transition).attr("font-size",d3.min([e.cellSize.width,12])).attr("dy",function(t){return e.axes.scale_x(e.get_heatmapCol(t)+1)}),e.svg.select(".row").selectAll(".label").transition(e.transition).attr("font-size",d3.min([e.cellSize.height,12])).attr("dy",function(t){return e.axes.scale_y(e.get_heatmapRow(t)+1)})):(e.svg.select(".col").selectAll(".label").attr("font-size",d3.min([e.cellSize.width,12])).attr("dy",function(t){return e.axes.scale_x(e.get_heatmapCol(t)+1)}),e.svg.select(".row").selectAll(".label").attr("font-size",d3.min([e.cellSize.height,12])).attr("dy",function(t){return e.axes.scale_y(e.get_heatmapRow(t)+1)})),e.updateCellPosition(),e},e.updateLabels=function(){var t=e.svg.select(".col").selectAll(".label").data(e.get_dispColIds(),function(t){return t});t.exit().remove();var n=e.svg.select(".row").selectAll(".label").data(e.get_dispRowIds(),function(t){return t});return n.exit().remove(),t.enter().append("text").attr("class","label").attr("transform","rotate(-90)").style("text-anchor","start").attr("dx",2).merge(t).on("mouseover",e.labelMouseOver).on("mouseout",e.labelMouseOut).on("click",e.labelClick),n.enter().append("text").attr("class","label").style("text-anchor","end").attr("dx",-2).merge(n).on("mouseover",e.labelMouseOver).on("mouseout",e.labelMouseOut).on("click",e.labelClick),e.updateCells(),e},e.updateLabelText=function(){return"undefined"!=typeof e.transition?(e.svg.select(".col").selectAll(".label").transition(e.transition).text(function(t){return e.get_colLabels(t)}),e.svg.select(".row").selectAll(".label").transition(e.transition).text(function(t){return e.get_rowLabels(t)})):(e.svg.select(".col").selectAll(".label").text(function(t){return e.get_colLabels(t)}),e.svg.select(".row").selectAll(".label").text(function(t){return e.get_rowLabels(t)})),e},e.zoom=function(t,n){var r=e.findPoints(t,n);if(!(r.size()<2)){for(var a=r.data().map(function(t){return t[0]}),o=r.data().map(function(t){return t[1]}),i=[],l=[],s=0;s<a.length;s++)-1==i.indexOf(a[s])&&i.push(a[s]);for(var s=0;s<o.length;s++)-1==l.indexOf(o[s])&&l.push(o[s]);return i.length>0&&e.dispRowIds(i),e.dispColIds(l),e.updateLabels(),e.updateLabelPosition(),e}},e.resetDomain=function(){return e.dispColIds(e.get_colIds),e.dispRowIds(e.get_rowIds),e.mark("__clear__"),e.updateLabels().updateLabelPosition().updateCellColour().updateLabelText(),e},e.resetColourScale=function(){var t=e.get_colourRange();e.colourScale=d3.scaleSequential(e.get_palette).domain(t),e.get_showLegend()&&e.updateLegend()},e.pointMouseOver=function(t){d3.select(this).attr("fill",function(t){return d3.rgb(e.get_colour(e.get_value(t[0],t[1]))).darker(.5)}).classed("hover",!0),e.svg.select(".col").selectAll(".label").filter(function(e){return e==t[1]}).classed("hover",!0),e.svg.select(".row").selectAll(".label").filter(function(e){return e==t[0]}).classed("hover",!0),e.get_showValue()?e.g.selectAll(".tval").filter(function(e){return e[0]==t[0]&&e[1]==t[1]}).classed("hidden",!1):(e.container.select(".inform").style("left",d3.event.pageX+10+"px").style("top",d3.event.pageY-10+"px").select(".value").html(function(){return e.get_informText(t[0],t[1])}),e.container.select(".inform").classed("hidden",!1))},e.pointMouseOut=function(){d3.select(this).attr("fill",function(t){return e.get_colour(e.get_value(t[0],t[1]))}).classed("hover",!1),e.svg.selectAll(".label").classed("hover",!1),e.get_showValue()?e.g.selectAll(".tval").classed("hidden",!0):e.container.select(".inform").classed("hidden",!0)},e.labelClick=function(t){var n;n=d3.select(this.parentNode).classed("row")?"row":"col",d3.select(this).classed("sorted")?"col"==n?e.reorderRow("flip"):e.reorderCol("flip"):"col"==n?e.reorderRow(function(n,r){return e.get_value(r,t)-e.get_value(n,t)}):e.reorderCol(function(n,r){return e.get_value(t,r)-e.get_value(t,n)}),d3.select(this).classed("sorted",!0),e.svg.selectAll(".sorted").classed("selected",!0)},e.updateCellColour=function(){return"undefined"!=typeof e.transition?e.g.selectAll(".data_point").transition(e.transition).attr("fill",function(t){return e.get_colour(e.get_value(t[0],t[1]))}):e.g.selectAll(".data_point").attr("fill",function(t){return e.get_colour(e.get_value(t[0],t[1]))}),e.svg.selectAll(".sorted").classed("selected",!1).classed("sorted",!1),e.get_showValue()&&e.updateTextValues(),e},e.updateCells=function(){var t=e.g.selectAll(".data_row").data(e.get_dispRowIds(),function(t){return t});t.exit().remove(),t.enter().append("g").attr("class","data_row");var n=e.g.selectAll(".data_row").selectAll(".data_point").data(function(t){return e.get_dispColIds().map(function(e){return[t,e]})},function(t){return t});return n.exit().remove(),n.enter().append("rect").attr("class","data_point").merge(n).on("mouseover",e.pointMouseOver).on("mouseout",e.pointMouseOut).on("click",function(t){e.get_on_click.apply(this,[t[0],t[1]])}),e.get_showValue()&&e.updateTexts(),e},e.updateCellPosition=function(){return"undefined"!=typeof e.transition?e.g.selectAll(".data_point").transition(e.transition).attr("x",function(t){return e.axes.scale_x(e.get_heatmapCol(t[1]))}).attr("width",e.cellSize.width).attr("height",e.cellSize.height).attr("y",function(t){return e.axes.scale_y(e.get_heatmapRow(t[0]))}):e.g.selectAll(".data_point").attr("x",function(t){return e.axes.scale_x(e.get_heatmapCol(t[1]))}).attr("width",e.cellSize.width).attr("height",e.cellSize.height).attr("y",function(t){return e.axes.scale_y(e.get_heatmapRow(t[0]))}),e.get_showValue()&&e.updateTextPosition(),e},e.cluster=function(t){if("Row"!=t&&"Col"!=t)throw"Error in 'cluster': type "+t+" cannot be recognised. Please, use either 'Row' or 'Col'";var n,r={},a=[],o=e["get_disp"+t+"Ids"]();n="Row"==t?e.get_dispColIds():e.get_dispRowIds();for(var i=0;i<o.length;i++){for(var l=0;l<n.length;l++)a.push("Row"==t?e.get_value(o[i],n[l]):e.get_value(n[l],o[i]));r[o[i]]=a.slice(),a=[]}var s=function(n,a){return e["get_cluster"+t+"Metric"](r[n],r[a])},d=[],c=function(t){return t.value?void d.push(t.value):(c(t.left),void c(t.right))},u=clusterfck.hcluster(o,s,clusterfck.COMPLETE_LINKAGE);c(u);var g=e["get_heatmap"+t]("__order__");return e["reorder"+t](function(t,e){return-1!=d.indexOf(t)&&-1!=d.indexOf(e)?d.indexOf(t)-d.indexOf(e):g.indexOf(t)-g.indexOf(e)}),e.updateLabelPosition(),e},e.updateTexts=function(){var t=e.g.selectAll(".text_row").data(e.get_dispRowIds(),function(t){return t});t.exit().remove(),t.enter().append("g").attr("class","text_row");var n=e.g.selectAll(".text_row").selectAll(".tval").data(function(t){return e.get_dispColIds().map(function(e){return[t,e]})},function(t){return t});return n.exit().remove(),n.enter().append("text").attr("class","tval hidden"),e},e.updateTextPosition=function(){return"undefined"!=typeof e.transition?e.g.selectAll(".tval").transition(e.transition).attr("x",function(t){return e.axes.scale_x(e.get_heatmapCol(t[1]))}).attr("font-size",.5*e.cellSize.height).attr("y",function(t){return e.axes.scale_y(e.get_heatmapRow(t[0]))+.75*e.cellSize.height}):e.g.selectAll(".tval").attr("x",function(t){return e.axes.scale_x(e.get_heatmapCol(t[1]))}).attr("font-size",.5*e.cellSize.height).attr("y",function(t){return e.axes.scale_y(e.get_heatmapRow(t[0]))+.75*e.cellSize.height}),e},e.updateTextValues=function(){return"undefined"!=typeof e.transition?e.g.selectAll(".tval").transition(e.transition).text(function(t){return e.get_value(t[0],t[1]).toFixed(1)}):e.g.selectAll(".tval").text(function(t){return e.get_value(t[0],t[1]).toFixed(1)}),e},e.updateLegendSize=function(){var t=d3.min([.5*e.get_margin().bottom,20]),n=d3.min([e.get_width()/23,30]),r=d3.min([.3*e.get_margin().bottom,n/2,15]),a=e.svg.select(".legend_panel").selectAll(".legend_block").attr("transform",function(t){return"translate("+(t+1)*n+", 0)"});a.selectAll("text").attr("font-size",r).attr("dy",.4*e.get_margin().bottom).attr("dx",n),a.selectAll("rect").attr("height",t).attr("width",n).attr("y",.5*e.get_margin().bottom)},e.updateLegend=function(){var t=e.get_colourRange(),n=(t[1]-t[0])/20,r=e.svg.select(".legend_panel").selectAll(".legend_block").data(d3.range(21)).enter().append("g").attr("class","legend_block");r.append("text").attr("text-anchor","end"),r.append("rect"),e.svg.select(".legend_panel").selectAll(".legend_block").selectAll("text").text(function(e){return e%2==0?(t[0]+n*e).toFixed(2):""}),e.svg.select(".legend_panel").selectAll(".legend_block").selectAll("rect").attr("fill",function(r){return e.colourScale(t[0]+n*r)})},e.update=function(){return e.updateTitle(),e.resetColourScale(),e.axes.x_label.text(e.get_colTitle()),e.axes.y_label.text(e.get_rowTitle()),e.updateLabels().updateSize().updateLabelText().updateCellColour(),e},e}function m(t,e,n){return 1/(1+Math.exp(-n*(t-e)))}function y(t,e,n,r){var a=m(n,t,e,0,1),o=m(r,t,e,0,1),i=Math.min(a,o);return function(n){return(m(n,t,e,1)-i)/Math.abs(o-a)}}function v(){var t=u().add_property("straightColorScale").add_property("midpoint",void 0).add_property("slopewidth",void 0).add_property("on_drag",function(){}).add_property("on_change",function(){}).margin({top:20,right:10,bottom:5,left:10}).height(80).transitionDuration(0);t.straightColorScale(d3.scaleLinear().range(["white","darkblue"])),t.clamp_markers=function(){var e=d3.min(t.get_straightColorScale.domain()),n=d3.max(t.get_straightColorScale.domain());t.get_midpoint()<e&&t.midpoint(e),t.get_midpoint()>n&&t.midpoint(n),t.get_slopewidth()>n-e&&t.slopewidth(n-e),t.get_slopewidth()<e-n&&t.slopewidth(e-n)};var e=t.put_static_content;t.put_static_content=function(n){e(n);var r=t.svg.append("g").attr("class","sigmoidColorSlider").attr("transform","translate("+t.get_margin().left+", "+t.get_margin().top+")");t.axis=r.append("g").attr("class","axis");var a=r.append("defs");t.gradient=a.append("linearGradient").attr("id","scaleGradient").attr("x1","0%").attr("y1","0%").attr("x2","100%").attr("y2","0%"),t.gradient.selectAll("stop").data(d3.range(100)).enter().append("stop").attr("offset",function(t){return t+"%"}),t.colorBar=r.append("rect").attr("x","0").attr("y","5").attr("height",20).attr("fill","url(#scaleGradient)").style("stroke","black").style("stroke-width","1"),a.append("path").attr("id","mainMarker").attr("d","M 0 0 L 8 5 L 8 25 L -8 25 L -8 5 Z").style("fill","gray").style("stroke","black"),a.append("path").attr("id","rightMarker").attr("d","M 0 0 L 5 5 L 5 15 L 0 15 Z").style("fill","lightgray").style("stroke","black"),a.append("path").attr("id","leftMarker").attr("d","M 0 0 L -5 5 L -5 15 L 0 15 Z").style("fill","lightgray").style("stroke","black"),t.mainMarker=r.append("use").attr("xlink:href","#mainMarker").attr("y",28).call(d3.drag().on("drag",function(){t.midpoint(t.pos_scale.invert(t.pos_scale(t.get_midpoint())+d3.event.dx)),t.clamp_markers(),t.get_on_drag(),t.update()}).on("end",function(){t.get_on_change()})),t.rightMarker=r.append("use").attr("xlink:href","#rightMarker").attr("y",30).call(d3.drag().on("drag",function(){t.slopewidth(t.pos_scale.invert(t.pos_scale(t.get_slopewidth())+d3.event.dx)),t.clamp_markers(),t.update(),t.get_on_drag()}).on("end",function(){t.get_on_change()})),t.leftMarker=r.append("use").attr("xlink:href","#leftMarker").attr("y",30).call(d3.drag().on("drag",function(){t.slopewidth(t.pos_scale.invert(t.pos_scale(t.get_slopewidth())-d3.event.dx)),t.clamp_markers(),t.update(),t.get_on_drag()}).on("end",function(){t.get_on_change()}))};var n=t.update;return t.update=function(){n();var e=d3.scaleLinear().domain([0,100]).range(t.get_straightColorScale.domain());void 0==t.get_midpoint()&&t.midpoint(e(50)),void 0==t.get_slopewidth()&&t.slopewidth(Math.abs(e(15))),t.pos_scale=d3.scaleLinear().range([0,t.get_plotWidth()]).domain(t.get_straightColorScale.domain()),d3.axisTop().scale(t.pos_scale)(t.axis),t.colorBar.attr("width",t.get_plotWidth()),t.the_sigmoid=y(t.get_midpoint(),1.38/t.get_slopewidth(),t.get_straightColorScale.domain()[0],t.get_straightColorScale.domain()[1]),t.gradient.selectAll("stop").data(d3.range(100)).style("stop-color",function(n){return t.get_straightColorScale(e(100*t.the_sigmoid(e(n))))}),t.colourScale=function(n){return t.get_straightColorScale(e(100*t.the_sigmoid(n)))},t.mainMarker.attr("x",t.pos_scale(t.get_midpoint())),t.rightMarker.attr("x",t.pos_scale(t.get_midpoint()+t.get_slopewidth())),t.leftMarker.attr("x",t.pos_scale(t.get_midpoint()-t.get_slopewidth()))},t}function x(){var t=u().add_property("record",{}),e=t.put_static_content;t.put_static_content=function(n){e(n),t.table=t.container.append("table").attr("border",1)};var n=t.update;return t.update=function(){n();var e=t.table.selectAll("tr").data(Object.keys(obj.get_record()));return e.exit().remove(),e.enter().append("tr").merge(e).html(function(e){return"<td>"+e+"</td><td>"+t.get_record()[e]+"</td>"}),t},t}t.base=e,t.layerBase=d,t.chartBase=u,t.axisChart=p,t.scatterChart=f,t.lineChart=_,t.heatmapChart=h,t.cache=n,t.separateBy=r,t.getEuclideanDistance=a,t.add_click_listener=o,t.pearsonCorr=i,t.fillTextBlock=s,t.sigmoidColorSlider=v,t.simpleTable=x,Object.defineProperty(t,"__esModule",{value:!0})});