...
var clusterfck=function(){var e=function(t,s){var r=e.resolve(t,s||"/"),n=e.modules[r];if(!n)throw new Error("Failed to resolve module "+t+", tried "+r);var i=n._cached?n._cached:n();return i};e.paths=[],e.modules={},e.extensions=[".js",".coffee"],e._core={assert:!0,events:!0,fs:!0,path:!0,vm:!0},e.resolve=function(){return function(t,s){function r(t){if(e.modules[t])return t;for(var s=0;s<e.extensions.length;s++){var r=e.extensions[s];if(e.modules[t+r])return t+r}}function n(t){t=t.replace(/\/+$/,"");var s=t+"/package.json";if(e.modules[s]){var n=e.modules[s](),i=n.browserify;if("object"==typeof i&&i.main){var o=r(u.resolve(t,i.main));if(o)return o}else if("string"==typeof i){var o=r(u.resolve(t,i));if(o)return o}else if(n.main){var o=r(u.resolve(t,n.main));if(o)return o}}return r(t+"/index")}function i(e,t){for(var s=o(t),i=0;i<s.length;i++){var u=s[i],a=r(u+"/"+e);if(a)return a;var l=n(u+"/"+e);if(l)return l}var a=r(e);return a?a:void 0}function o(e){var t;t="/"===e?[""]:u.normalize(e).split("/");for(var s=[],r=t.length-1;r>=0;r--)if("node_modules"!==t[r]){var n=t.slice(0,r+1).join("/")+"/node_modules";s.push(n)}return s}if(s||(s="/"),e._core[t])return t;var u=e.modules.path(),a=s||".";if(t.match(/^(?:\.\.?\/|\/)/)){var l=r(u.resolve(a,t))||n(u.resolve(a,t));if(l)return l}var c=i(t,a);if(c)return c;throw new Error("Cannot find module '"+t+"'")}}(),e.alias=function(s,r){var n=e.modules.path(),i=null;try{i=e.resolve(s+"/package.json","/")}catch(o){i=e.resolve(s,"/")}for(var u=n.dirname(i),a=t(e.modules),l=0;l<a.length;l++){var c=a[l];if(c.slice(0,u.length+1)===u+"/"){var h=c.slice(u.length);e.modules[r+h]=e.modules[u+h]}else c===u&&(e.modules[r]=e.modules[u])}},e.define=function(t,s){var r=e._core[t]?"":e.modules.path().dirname(t),n=function(t){return e(t,r)};n.resolve=function(t){return e.resolve(t,r)},n.modules=e.modules,n.define=e.define;var i={exports:{}};e.modules[t]=function(){return e.modules[t]._cached=i.exports,s.call(i.exports,n,i,i.exports,r,t),e.modules[t]._cached=i.exports,i.exports}};var t=Object.keys||function(e){var t=[];for(var s in e)t.push(s);return t};return"undefined"==typeof process&&(process={}),process.nextTick||(process.nextTick=function(e){setTimeout(e,0)}),process.title||(process.title="browser"),process.binding||(process.binding=function(t){if("evals"===t)return e("vm");throw new Error("No such module")}),process.cwd||(process.cwd=function(){return"."}),e.define("path",function(e,t,s){function r(e,t){for(var s=[],r=0;r<e.length;r++)t(e[r],r,e)&&s.push(e[r]);return s}function n(e,t){for(var s=0,r=e.length;r>=0;r--){var n=e[r];"."==n?e.splice(r,1):".."===n?(e.splice(r,1),s++):s&&(e.splice(r,1),s--)}if(t)for(;s--;s)e.unshift("..");return e}var i=/^(.+\/(?!$)|\/)?((?:.+?)?(\.[^.]*)?)$/;s.resolve=function(){for(var e="",t=!1,s=arguments.length;s>=-1&&!t;s--){var i=s>=0?arguments[s]:process.cwd();"string"==typeof i&&i&&(e=i+"/"+e,t="/"===i.charAt(0))}return e=n(r(e.split("/"),function(e){return!!e}),!t).join("/"),(t?"/":"")+e||"."},s.normalize=function(e){var t="/"===e.charAt(0),s="/"===e.slice(-1);return e=n(r(e.split("/"),function(e){return!!e}),!t).join("/"),e||t||(e="."),e&&s&&(e+="/"),(t?"/":"")+e},s.join=function(){var e=Array.prototype.slice.call(arguments,0);return s.normalize(r(e,function(e){return e&&"string"==typeof e}).join("/"))},s.dirname=function(e){var t=i.exec(e)[1]||"",s=!1;return t?1===t.length||s&&t.length<=3&&":"===t.charAt(1)?t:t.substring(0,t.length-1):"."},s.basename=function(e,t){var s=i.exec(e)[2]||"";return t&&s.substr(-1*t.length)===t&&(s=s.substr(0,s.length-t.length)),s},s.extname=function(e){return i.exec(e)[3]||""}}),e.define("/clusterfck.js",function(e,t){t.exports={hcluster:e("./hcluster"),kmeans:e("./kmeans")}}),e.define("/hcluster.js",function(e,t){var s=e("./distance"),r=function(e,t,s){this.distance=e,this.linkage=t,this.threshold=void 0==s?1/0:s};r.prototype={cluster:function(e,t,s){this.clusters=[],this.dists=[],this.mins=[],this.index=[];for(var r=0;r<e.length;r++){var n={value:e[r],key:r,index:r,size:1};this.clusters[r]=n,this.index[r]=n,this.dists[r]=[],this.mins[r]=0}for(var r=0;r<this.clusters.length;r++)for(var i=0;r>=i;i++){var o=r==i?1/0:this.distance(this.clusters[r].value,this.clusters[i].value);this.dists[r][i]=o,this.dists[i][r]=o,o<this.dists[r][this.mins[r]]&&(this.mins[r]=i)}for(var u=this.mergeClosest(),r=0;u;)s&&r++%t==0&&s(this.clusters),u=this.mergeClosest();return this.clusters.forEach(function(e){delete e.key,delete e.index}),this.clusters},mergeClosest:function(){for(var e=0,t=1/0,s=0;s<this.clusters.length;s++){var r=this.clusters[s].key,n=this.dists[r][this.mins[r]];t>n&&(e=r,t=n)}if(t>=this.threshold)return!1;var i=this.index[e],o=this.index[this.mins[e]],u={left:i,right:o,key:i.key,size:i.size+o.size};this.clusters[i.index]=u,this.clusters.splice(o.index,1),this.index[i.key]=u;for(var s=0;s<this.clusters.length;s++){var n,a=this.clusters[s];i.key==a.key?n=1/0:"single"==this.linkage?(n=this.dists[i.key][a.key],this.dists[i.key][a.key]>this.dists[o.key][a.key]&&(n=this.dists[o.key][a.key])):"complete"==this.linkage?(n=this.dists[i.key][a.key],this.dists[i.key][a.key]<this.dists[o.key][a.key]&&(n=this.dists[o.key][a.key])):n="average"==this.linkage?(this.dists[i.key][a.key]*i.size+this.dists[o.key][a.key]*o.size)/(i.size+o.size):this.distance(a.value,i.value),this.dists[i.key][a.key]=this.dists[a.key][i.key]=n}for(var s=0;s<this.clusters.length;s++){var l=this.clusters[s].key;if(this.mins[l]==i.key||this.mins[l]==o.key){for(var t=l,c=0;c<this.clusters.length;c++){var h=this.clusters[c].key;this.dists[l][h]<this.dists[l][t]&&(t=h)}this.mins[l]=t}this.clusters[s].index=s}return delete i.key,delete o.key,delete i.index,delete o.index,!0}};var n=function(e,t,n,i,o,u){t=t||"euclidean",n=n||"average","string"==typeof t&&(t=s[t]);var a=new r(t,n,i).cluster(e,o,u);return void 0===i?a[0]:a};t.exports=n}),e.define("/distance.js",function(e,t){t.exports={euclidean:function(e,t){for(var s=0,r=0;r<e.length;r++)s+=Math.pow(t[r]-e[r],2);return Math.sqrt(s)},manhattan:function(e,t){for(var s=0,r=0;r<e.length;r++)s+=Math.abs(t[r]-e[r]);return s},max:function(e,t){for(var s=0,r=0;r<e.length;r++)s=Math.max(s,Math.abs(t[r]-e[r]));return s}}}),e.define("/kmeans.js",function(e,t){function s(e,t){var s=e.slice(0);return s.sort(function(){return Math.round(Math.random())-.5}),s.slice(0,t)}function r(e,t,s){for(var r=1/0,n=0,i=0;i<t.length;i++){var o=s(e,t[i]);r>o&&(r=o,n=i)}return n}function n(e,t,n,o,u){n=n||"euclidean","string"==typeof n&&(n=i[n]);for(var a=s(e,t),l=new Array(e.length),c=new Array(t),h=0,f=!0;f;){for(var d=0;d<e.length;d++)l[d]=r(e[d],a,n);f=!1;for(var v=0;t>v;v++){var m=[];if(l.forEach(function(t,s){t==v&&m.push(e[s])}),m.length){for(var g=a[v],p=new Array(g.length),y=0;y<g.length;y++){for(var k=0,d=0;d<m.length;d++)k+=m[d][y];p[y]=k/m.length,p[y]!=g[y]&&(f=!0)}a[v]=p,c[v]=m}}u&&h++%o==0&&u(c)}return c}var i=e("./distance");t.exports=n}),e("/clusterfck")}();
//linked-charts
(function(global,factory){typeof exports==="object"&&typeof module!=="undefined"?factory(exports):typeof define==="function"&&define.amd?define(["exports"],factory):factory(global.lc=global.lc||{})})(this,function(exports){"use strict";function base(){var obj={};obj.propList=[];obj.add_property=function(propname,defaultval){obj.propList.push(propname);var getter="get_"+propname;var overrideList={};obj[propname]=function(vf,propname,overrideFunc){if(vf===undefined)return obj[getter]();if(vf=="_override_"){if(typeof overrideFunc==="function")overrideList[propname]=overrideFunc;else overrideList[propname]=function(){return overrideFunc}}else{if(typeof vf==="function")obj[getter]=vf;else obj[getter]=function(){return vf};for(var i in overrideList)obj["get_"+i]=overrideList[i]}if(obj.layers)return obj;else if(obj.chart)return obj.chart;else return obj};if(typeof defaultval==="function")obj[getter]=defaultval;else obj[getter]=function(){return defaultval};return obj};return obj}function cache(f){var the_cache={};return function(){if(arguments[0]==="clear"){the_cache={};return undefined}if(!(arguments in Object.keys(the_cache))&&!(arguments.length==0&&Object.keys(the_cache).length!=0))the_cache[arguments]=f.apply(undefined,arguments);return the_cache[arguments]}}function separateBy(data,properties){if(typeof data!=="object")throw"Error in function 'separateBy': first argument is not an object";var type;typeof data.length==="undefined"?type="obj":type="arr";if(typeof properties==="number"||typeof properties==="string")properties=[properties];if(typeof properties.length==="undefined")throw"Error in function 'separateBy': "+properties.toString()+" is not a property name";if(properties.length==0)return data;var newData={},uniqueList=[],keys,value;var keys=Object.keys(data);for(var i=0;i<keys.length;i++){if(typeof data[keys[i]][properties[0]]!=="undefined"&&uniqueList.indexOf(data[keys[i]][properties[0]])==-1)uniqueList.push(data[keys[i]][properties[0]])}if(uniqueList.length==0){properties.shift();return separateBy(data,properties)}for(var i=0;i<uniqueList.length;i++)type=="obj"?newData[uniqueList[i]]={}:newData[uniqueList[i]]=[];for(var i=0;i<keys.length;i++){value=data[keys[i]][properties[0]];if(typeof value!=="undefined"){delete data[keys[i]][properties[0]];if(type=="obj")newData[value][keys[i]]={};type=="obj"?Object.assign(newData[value][keys[i]],data[keys[i]]):newData[value].push(data[keys[i]])}}if(type=="arr"){var change=true,i=0;while(change&&i<uniqueList.length){change=newData[uniqueList[i]].length==1;i++}if(change){var a;for(var i=0;i<uniqueList.length;i++){a={};Object.assign(a,newData[uniqueList[i]][0]);newData[uniqueList[i]]={};Object.assign(newData[uniqueList[i]],a)}}}properties.shift();for(var i=0;i<uniqueList.length;i++)newData[uniqueList[i]]=separateBy(newData[uniqueList[i]],properties.slice());return newData}function getEuclideanDistance(a,b){if(a.length!=b.length)throw"Error in getEuclideanDistance: length of the"+"input vectors is not the same";var sum=0;for(var i=0;i<a.length;i++)sum+=(a[i]-b[i])*(a[i]-b[i]);return Math.sqrt(sum)}function add_click_listener(chart){var wait_dblClick=null,down,wait_click=null,tolerance=5,click_coord,downThis,event=d3.dispatch("click","dblclick");chart.svg.select(".plotArea").append("rect").attr("class","clickPanel").attr("fill","transparent").lower();var inherited_updateSize=chart.updateSize;chart.updateSize=function(){inherited_updateSize();chart.svg.selectAll(".clickPanel").attr("width",chart.plotWidth()).attr("height",chart.plotHeight());return chart};var on_mousedown=function(){down=d3.mouse(document.body);downThis=d3.mouse(this);wait_click=window.setTimeout(function(){wait_click=null},1e3);var p=d3.mouse(this);chart.svg.select(".plotArea").append("rect").attr("class","selection").attr("x",p[0]).attr("y",p[1]).attr("width",1).attr("height",1);chart.container.select(".inform").classed("blocked",true)};var on_mousemove=function(){var s=chart.svg.select(".selection");if(!s.empty()){var p=d3.mouse(this);s.attr("x",d3.min([p[0],downThis[0]])).attr("y",d3.min([downThis[1],p[1]])).attr("width",Math.abs(downThis[0]-p[0])).attr("height",Math.abs(downThis[1]-p[1]));var shadow=chart.svg.select(".shadow");if(shadow.empty()&&Math.abs((downThis[0]-p[0])*(downThis[1]-p[1]))>10)shadow=chart.svg.select(".plotArea").append("path").attr("class","shadow").attr("fill","#444").attr("opacity",.6);shadow.attr("d","M 0 0"+" h "+chart.plotWidth()+" v "+chart.plotHeight()+" h -"+chart.plotWidth()+" v -"+chart.plotHeight()+" M "+s.attr("x")+" "+s.attr("y")+" v "+s.attr("height")+" h "+s.attr("width")+" v -"+s.attr("height")+" h -"+s.attr("width"))}};var on_mouseup=function(){var mark=d3.event.shiftKey||chart.selectMode;chart.container.select(".inform").classed("blocked",false);var x=chart.svg.selectAll("rect.selection").attr("x")*1,y=chart.svg.selectAll("rect.selection").attr("y")*1,w=chart.svg.selectAll("rect.selection").attr("width")*1,h=chart.svg.selectAll("rect.selection").attr("height")*1,lu=[x,y],rb=[x+w,y+h],points=d3.select(this),pos=d3.mouse(this);chart.svg.selectAll("rect.selection").remove();chart.svg.select(".shadow").remove();if(wait_click&&getEuclideanDistance(down,d3.mouse(document.body))<tolerance){window.clearTimeout(wait_click);wait_click=null;if(wait_dblClick&&getEuclideanDistance(click_coord,d3.mouse(document.body))<tolerance){window.clearTimeout(wait_dblClick);wait_dblClick=null;points.on("dblclick").apply(points,[mark])}else{wait_dblClick=window.setTimeout(function(e){return function(){points.on("click").call(points,pos,mark);wait_dblClick=null}}(d3.event),300)}click_coord=d3.mouse(document.body);return}if(mark)chart.mark(chart.findPoints(lu,rb));else chart.zoom(lu,rb)};var on_dblclick=function(mark){mark?chart.mark("__clear__"):chart.resetDomain()};var on_panelClick=function(p,mark){var clickedPoints=chart.findPoints(p,p);if(!mark){var click,clickFun,data;for(var i=0;i<clickedPoints.length;i++){click=chart.svg.select("#"+lc.escapeRegExp(clickedPoints[i]).replace(/ /g,"_"));if(!click.empty()){clickFun=click.on("click");clickFun.call(click.node(),click.datum())}else{data=clickedPoints[i].substr(1).split("_-sep-_");chart.get_on_click(data)}}}else{chart.mark(clickedPoints)}};chart.svg.select(".plotArea").on("mousedown",on_mousedown).on("mousemove",on_mousemove).on("mouseup",on_mouseup).on("dblclick",on_dblclick).on("click",on_panelClick);return chart}function pearsonCorr(v1,v2){var sum1=0;var sum2=0;for(var i=0;i<v1.length;i++){sum1+=v1[i];sum2+=v2[i]}var mean1=sum1/v1.length;var mean2=sum2/v2.length;var cov=0;var var1=0;var var2=0;for(var i=0;i<v1.length;i++){cov+=(v1[i]-mean1)*(v2[i]-mean2);var1+=(v1[i]-mean1)*(v1[i]-mean1);var2+=(v2[i]-mean2)*(v2[i]-mean2)}return cov/Math.sqrt(var1*var2)}function wrapText(text,width,height,minSize,maxSize,fontRatio){var splitBy=function(text,symbol){var spl=text.split(symbol);if(spl[spl.length-1]=="")spl.pop();if(spl.length==1)return;var mult=0,bestSep,leftSide=0,rightSide=text.length;for(var i=0;i<spl.length-1;i++){leftSide+=spl[i].length+1;rightSide-=spl[i].length+1;if(mult<leftSide*rightSide){mult=leftSide*rightSide;bestSep=i}}return[spl.slice(0,bestSep+1).join(symbol)+symbol,spl.slice(bestSep+1,spl.length-bestSep).join(symbol)]};var splitByVowel=function(text){var vowelInd=Array.apply(null,Array(text.length)).map(Number.prototype.valueOf,0),vowels=["a","A","o","O","e","E","u","U","i","I"];for(var i=0;i<text.length;i++)if(vowels.indexOf(text[i])!=-1)vowelInd[i]=1;for(var i=0;i<vowelInd.length-1;i++)vowelInd[i]=(vowelInd[i]-vowelInd[i+1])*vowelInd[i];vowelInd[vowelInd.length-1]=0;vowelInd[vowelInd.length-2]=0;if(vowelInd.indexOf(1)==-1)return[text.substring(0,Math.ceil(text.length/2))+"-",text.substring(Math.ceil(text.length/2))];var mult=0,bestSep;for(var i=0;i<text.length;i++)if(vowelInd[i]==1)if(mult<(i+2)*(text.length-i-1)){mult=(i+2)*(text.length-i-1);bestSep=i}return[text.substring(0,bestSep+1)+"-",text.substring(bestSep+1)]};if(typeof minSize==="undefined")minSize=8;if(typeof maxSize==="undefined")maxSize=13;if(typeof fontRatio==="undefined")fontRatio=.6;var fontSize=d3.min([height,maxSize]),spans=[text],maxLength=text.length,allowedLength,longestSpan=0,mult,br;while(maxLength*fontSize*fontRatio>width&&fontSize>=minSize){if(maxLength==1)fontSize=width/fontRatio*.95;else{if(height/(spans.length+1)<width/(maxLength*fontRatio)*.95)fontSize=width/(maxLength*fontRatio)*.95;else{var charachters=[" ",".",",","/","\\","-","_","+","*","&","(",")","?","!"],spl,i=0;while(typeof spl==="undefined"&&i<charachters.length){spl=splitBy(spans[longestSpan],charachters[i]);i++}if(typeof spl==="undefined")spl=splitByVowel(spans[longestSpan]);spans.splice(longestSpan,1,spl[0],spl[1]);allowedLength=Math.floor(width/(fontSize*fontRatio));for(var i=0;i<spans.length-1;i++)if(spans[i].length+spans[i+1].length<=allowedLength&&spans[i].length+spans[i+1].length<maxLength){spans.splice(i,2,spans[i]+spans[i+1]);fontSize=d3.min([height/(spans.length-1),maxSize]);allowedLength=Math.floor(width/(fontSize*fontRatio))}fontSize=d3.min([height/spans.length,maxSize]);maxLength=spans[0].length;longestSpan=0;for(var i=1;i<spans.length;i++)if(spans[i].length>maxLength){maxLength=spans[i].length;longestSpan=i}}}}return{spans:spans,fontSize:fontSize}}function fillTextBlock(g,width,height,text,minSize,maxSize,fontRatio){var fit=wrapText(text,width,height,minSize,maxSize,fontRatio),spans=g.selectAll("text").data(d3.range(fit.spans.length));spans.exit().remove();spans.enter().append("text").merge(spans).attr("class","plainText").attr("text-anchor","left").attr("font-size",fit.fontSize).attr("y",function(d){return(d+1)*fit.fontSize}).text(function(d){return fit.spans[d]})}function get_symbolSize(type,r){var sizeCoef={Circle:28.2,Cross:35,Diamond:46,Square:36,Star:47,Triangle:44,Wye:37};return Math.pow(r*28.2/sizeCoef[type],2)*3.14}function escapeRegExp(str){return str.replace(/[\[\]\/\{\}\(\)\*\+\?\.\\\^\$\|]/g,"\\$&")}function layerBase(id){var layer=base().add_property("npoints").add_property("dataIds").add_property("pointMouseOver",function(){}).add_property("pointMouseOut",function(){}).add_property("on_click",function(){}).add_property("layerDomainX").add_property("layerDomainY").add_property("contScaleX",true).add_property("contScaleY",true).add_property("colour",function(id){return layer.colourScale(layer.get_colourValue(id))}).add_property("addColourScaleToLegend",true).add_property("palette").add_property("colourRange").add_property("colourValue",undefined).add_property("dresser",function(){});layer.id=id;layer.dataIds("_override_","npoints",function(){return layer.get_dataIds().length});layer.npoints("_override_","dataIds",function(){return d3.range(layer.get_npoints())});layer.colour("_override_","addColourScaleToLegend",false);layer.colourRange(function(){var ids=layer.get_dataIds();if(layer.get_colourValue(ids[0])!==undefined){var range=[];for(var i=0;i<ids.length;i++)if(range.indexOf(layer.get_colourValue(ids[i]))==-1)range.push(layer.get_colourValue(ids[i]));return range}});layer.colourScale=function(){return"black"};layer.resetColourScale=function(){var range=layer.get_colourRange();if(range===undefined)return;var allNum=true;for(var i=0;i<range.length;i++)allNum=allNum&&typeof range[i]==="number";if(allNum)range.sort(function(a,b){return a-b});if(allNum){if(typeof layer.get_palette()=="undefined")if(d3.interpolateSpectral)layer.palette(d3.interpolateSpectral);else layer.palette(["red","yellow","green","blue"]);if(layer.get_palette().splice){var palette=layer.get_palette();if(palette.length!=range.length)range=[d3.min(range),d3.max(range)];if(palette.length==1)palette.push(palette[0]);if(palette.length>range.length){var newRange=[];for(var i=0;i<palette.length;i++)newRange.push(range[0]+i*(range[1]-range[0])/(palette.length-1));range=newRange}layer.colourValueScale=d3.scaleLinear().domain(range).range(palette);layer.colourScale=function(val){return layer.colourValueScale(val)}}else{range=[d3.min(range),d3.max(range)];var pDomain=[0,1];if(layer.get_palette().domain)pDomain=layer.get_palette().domain();layer.colourValueScale=d3.scaleLinear().domain(range).range(pDomain);layer.colourScale=function(val){return layer.get_palette(layer.colourValueScale(val))}}}else{if(typeof layer.get_palette()==="undefined")layer.palette(["#000"].concat(d3.schemeCategory10));if(layer.get_palette().length){var palette=layer.get_palette();var paletteLength=palette.length;for(var i=0;i<range.length-paletteLength;i++)palette.push(palette[i%paletteLength]);layer.colourValueScale=d3.scaleOrdinal().domain(range).range(palette);layer.colourScale=function(val){return layer.colourValueScale(val)}}else{var pDomain=[0,1];if(layer.get_palette().domain)pDomain=layer.get_palette().domain();layer.colourValueScale=d3.scalePoint().domain(range).range(pDomain);layer.colourScale=function(val){return layer.get_palette(layer.colourValueScale(val))}}}layer.colourScale.domain=layer.get_colourRange;if(layer.chart.showLegend())layer.addLegend(layer.colourScale,"colour",layer.id)};layer.legendBloccks=[];layer.addLegend=function(scale,type,id){layer.chart.legend.add(scale,type,id,layer);layer.legendBloccks.push(id);return layer};layer.update=function(){layer.updatePoints();layer.updatePointStyle();layer.updatePointLocation();return layer};layer.put_static_content=function(){layer.g=layer.chart.svg.select(".plotArea").append("g").attr("class","chart_g").attr("id",layer.id).attr("clip-path","url(#viewBox)")};layer.afterUpdate=function(){};layer.updateSize=function(){};layer.updatePoints=function(){};layer.updatePointStyle=function(){layer.resetColourScale();layer.get_dresser(layer.g.selectAll(".data_point"));return layer};layer.updatePointLocation=function(){};layer.findPoints=function(){return[]};return layer}function legend(chart){var legend=base().add_property("width",200).add_property("height",function(){return chart.height()}).add_property("sampleHeight",20).add_property("ncol",undefined).add_property("location");legend.blocks={};legend.chart=chart;legend.add=function(scale,type,id,layer){var block={};if(typeof scale==="function")block.scale=scale;else block.scale=function(){return scale};if(typeof layer!=="undefined")block.layer=layer;if(["colour","size","style","symbol","dash"].indexOf(type)==-1)throw"Error in 'legend.add': "+type+" is not a suitable type of legend block. "+"Please, use one of these: 'colour', 'size', 'symbol', 'dash'";block.type=type;legend.blocks[id]=block;legend.updateGrid();return legend.chart};legend.updateScale=function(scale,id){if(typeof legend.blocks[id]==="undefined")throw"Error in 'legend.updateScale': A block with ID "+id+" is not defined";legend.blocks[id].scale=scale;legend.updateBlock(id);return legend.chart};legend.convertScale=function(id){var scale,newScale;if(typeof legend.blocks[id].scale==="function")scale=legend.blocks[id].scale();if(typeof scale==="undefined"||typeof scale!=="function"&&typeof scale.splice==="undefined")scale=legend.blocks[id].scale;if(typeof scale!=="function"){var scCont=false,rCont=false;if(scale.length==1)throw"Error in 'legend.add': range of the scale is not defined.";if(scale[0].length==2&&typeof scale[0][0]==="number"&&typeof scale[0][1]==="number")scCont=true;if(legend.blocks[id].type=="colour"&&scale[0].length!=scale[1].length)rCont=true;if(scale[1].length==2&&typeof scale[0][0]==="number"&&typeof scale[0][1]==="number")rCont=true;if(scCont&&rCont){newScale=d3.scaleLinear().domain(scale[0]).range(scale[1]);scale.steps?newScale.steps=scale.steps:newScale.steps=9}if(scCont&&!rCont){newScale=d3.scaleQuantize().domain(scale[0]).range(scale[1]);newScale.steps=scale[1].length}if(!scCont&&rCont){newScale=d3.scalePoint().domain(scale[0]).range(scale[1]);newScale.steps=scale[0].length}if(!scCont&&!rCont){if(scale[0].length>scale[1].length)scale[0].splice(scale[1].length);if(scale[1].length>scale[0].length)scale[1].splice(scale[0].length);newScale=d3.scaleOrdinal().domain(scale[0]).range(scale[1]);newScale.steps=scale[0].length}legend.blocks[id].domain=scale[0];if(typeof newScale.domain==="undefined")newScale.domain=legend.blocks[id].domain}else{if(typeof scale!=="function")throw"Error in 'legend.add': the type of scale argument is not suported. "+"Scale should be an array or a function.";var domain;typeof scale.domain==="function"?domain=scale.domain():domain=scale.domain;if(typeof domain==="undefined")throw"Error in 'legend.add': the domain of the scale is not defined.";legend.blocks[id].domain=domain;newScale=scale;if(scale.steps)newScale.steps=scale.steps;else{domain.length==2?newScale.steps=9:newScale.steps=domain.length}}return newScale};legend.remove=function(id){if(typeof legend.blocks[id]==="undefined")throw"Error in 'legend.remove': block with ID "+id+" doesn't exist";if(typeof legend.blocks[id].layer!=="undefined")legend.blocks[id].layer.legendBlocks.splice(legend.blocks[id].layer.legendBlocks.indexOf(id),1);delete legend.blocks[id];legend.g.select("#"+id).remove();legend.updateGrid();return legend.chart};legend.rename=function(oldId,newId){legend.blocks[newId]=legendBlocks.blocks[oldId];delete legend.blocks[oldId];if(typeof legend.blocks[newId].layer!=="undefined")legend.blocks[newId].layer.legendBlocks.splice(legend.blocks[newId].layer.legendBlocks.indexOf(oldId),1,newId);legend.g.select("#"+oldId).attr("id",newId);legend.update();return legend.chart};legend.updateGrid=function(){var bestWidth,bestHeight,n=Object.keys(legend.blocks).length;if(typeof legend.ncol()==="undefined"){var minSum=1+n,j;bestHeight=1;for(var i=2;i<=Math.ceil(Math.sqrt(n));i++){j=Math.ceil(n/i);if(i+j<=minSum){minSum=i+j;bestHeight=i}}bestWidth=Math.ceil(n/bestHeight)}else{bestWidth=legend.ncol();bestHeight=Math.ceil(n/bestWidth)}legend.location().select(".legendTable").remove();legend.location().append("table").attr("class","legendTable").selectAll("tr").data(d3.range(bestHeight)).enter().append("tr");legend.location().selectAll("tr").selectAll("td").data(function(d){return d3.range(bestWidth).map(function(e){return[d,e]})}).enter().append("td").attr("id",function(d){try{return Object.keys(legend.blocks)[d[0]*bestWidth+d[1]].replace(/ /g,"_")}catch(exc){return undefined}});for(var i in legend.blocks)legend.updateBlock(i)};legend.updateBlock=function(id){if(typeof legend.blocks[id]==="undefined")throw"Error in 'legend.updateBlock': block with ID "+id+" is not defined";var scale=legend.convertScale(id),tableCell=legend.location().select("#"+id.replace(/ /g,"_")),cellWidth=legend.width()/legend.location().select("tr").selectAll("td").size(),steps=scale.steps,cellHeight=legend.sampleHeight()*steps;var blockSvg=tableCell.selectAll("svg");if(blockSvg.empty())blockSvg=tableCell.append("svg");blockSvg.attr("width",cellWidth).attr("height",cellHeight);var title=blockSvg.select(".title");if(title.empty())title=blockSvg.append("g").attr("class","title");var titleWidth=d3.min([20,cellWidth*.2]);fillTextBlock(title,cellHeight,titleWidth,id);title.attr("transform","rotate(-90)translate(-"+cellHeight+", 0)");var sampleValues;if(legend.blocks[id].domain.length==steps)sampleValues=legend.blocks[id].domain;else sampleValues=d3.range(steps).map(function(e){return legend.blocks[id].domain[0]+e*(legend.blocks[id].domain[1]-legend.blocks[id].domain[0])/(steps-1)});var sampleData=[];for(var i=0;i<sampleValues.length;i++)sampleData.push([sampleValues[i]]);var samples=blockSvg.selectAll(".sample").data(sampleData);samples.exit().remove();samples.enter().append("g").attr("class","sample").merge(samples).attr("transform",function(d,i){return"translate("+(titleWidth+1)+", "+i*legend.sampleHeight()+")"});if(legend.blocks[id].type=="colour"){var rect=blockSvg.selectAll(".sample").selectAll("rect").data(function(d){return d});rect.enter().append("rect").merge(rect).attr("width",titleWidth).attr("height",legend.sampleHeight()).attr("fill",function(d){return scale(d)})}if(legend.blocks[id].type=="symbol"){var size=d3.min([legend.sampleHeight()/2,titleWidth/2]);var symbols=blockSvg.selectAll(".sample").selectAll("path").data(function(d){return d});symbols.enter().append("path").merge(symbols).attr("d",function(d){return d3.symbol().type(d3["symbol"+scale(d)]).size(get_symbolSize(scale(d),size))()}).attr("transform","translate("+size+", "+size+")")}if(legend.blocks[id].type=="dash"){var lines=blockSvg.selectAll(".sample").selectAll("line").data(function(d){return d});lines.enter().append("line").style("stroke","black").merge(lines).attr("x1",0).attr("x2",titleWidth).attr("y1",legend.sampleHeight()/2).attr("y2",legend.sampleHeight()/2).attr("stroke-dasharray",function(d){return scale(d)})}var sampleText=blockSvg.selectAll(".sample").selectAll("g").data(function(d){return typeof d[0]==="number"?[d[0].toString()]:d});sampleText.enter().append("g").merge(sampleText).attr("transform","translate("+(titleWidth+5)+", 0)");blockSvg.selectAll(".sample").selectAll("g").each(function(d){fillTextBlock(d3.select(this),cellWidth-2*titleWidth-5,legend.sampleHeight(),d)})};legend.update=function(){legend.updateGrid()};return legend}function panel(chart){var panel=base().add_property("x",function(){return chart.width()-panel.buttonSize-5}).add_property("y",function(){return chart.margin().top*.05}).add_property("orientation","horizontal").add_property("height",function(){if(panel.orientation()=="vertical")return Math.floor(chart.height()-panel.y()/panel.buttonSize)*panel.buttonSize;else return undefined}).add_property("width",function(){if(panel.orientation()=="horizontal")return Math.floor(chart.width()-panel.x()/panel.buttonSize)*panel.buttonSize;else return undefined});panel.chart=chart;panel.buttons=[];panel.buttonSize=30;panel.put_static_content=function(){panel.g=panel.chart.svg.append("g").attr("class","panel_g");panel.initDefs();panel.g.append("use").attr("xlink:href","#toggleOff").attr("id","toggle").attr("opacity",.7).attr("title","Click to show instrument panel").on("mouseover",function(){d3.select(this).attr("opacity",1)}).on("mouseout",function(){d3.select(this).attr("opacity",.7)}).on("click",panel.show).append("title").text("Click to show instrument panel");panel.g.append("g").attr("id","buttonPanel").attr("class","hidden");var buttons=panel.g.select("#buttonPanel").selectAll(".button").data(panel.buttons);buttons.enter().append("use").attr("opacity",.6).attr("class","button").attr("xlink:href",function(d){return d.icon}).on("click",function(d){d.fun(panel.chart,d3.select(this))}).on("mouseover",function(){d3.select(this).attr("opacity",1)}).on("mouseout",function(){d3.select(this).attr("opacity",.6)}).append("title").text(function(d){return d.name})};panel.updateSize=function(){var layout=panel.placeButtons();if(panel.orientation()=="vertical"){panel.g.attr("transform","translate("+panel.x()+", "+panel.y()+")");panel.g.select("#toggle").attr("transform","translate(0, 0)");panel.g.select("#buttonPanel").attr("transform","translate(0, "+panel.buttonSize+")")}else{panel.g.attr("transform","translate("+(panel.x()-panel.buttonSize*panel.buttons.length)+", "+panel.y()+")");panel.g.select("#toggle").attr("transform","translate("+panel.buttonSize*panel.buttons.length+", 0)");panel.g.select("#buttonPanel").attr("transform","translate(0, 0)")}};panel.placeButtons=function(){var rowLength;if(panel.orientation()=="horizontal"){rowLength=panel.optimizeSize(panel.buttons.length,panel.width(),panel.height());panel.g.selectAll(".button").attr("transform",function(d,i){return"translate("+i%rowLength*panel.buttonSize+", "+Math.floor(i/rowLength)*panel.buttonSize+")"})}else{rowLength=panel.optimizeSize(panel.buttons.length,panel.height(),panel.width());panel.g.selectAll(".button").attr("transform",function(d,i){return"translate("+Math.floor(i/rowLength)*panel.buttonSize+", "+(i%rowLength+1)*panel.buttonSize+")"})}};panel.optimizeSize=function(n,width,height){var rows,size;if(height){size=d3.min([width,height]);rows=1;while(Math.floor(width/size)*rows<n){rows++;size=d3.min([height/rows,size])}panel.buttonSize=size}else{size=panel.buttonSize;rows=Math.ceil(width/size)}if(panel.orientation()=="horizontal"){panel.width(size*Math.floor(width/size))}else{panel.height(size*Math.floor(width/size))}return Math.floor(width/size)};panel.add_button=function(name,icon,fun){panel.buttons.push({name:name,icon:icon,fun:fun})};panel.show=function(){panel.g.select("#toggle").attr("opacity",1).on("click",panel.hide).on("mouseout",function(){}).select("title").text("Click to hide instrument panel");if(panel.orientation()=="horizontal")panel.g.select("#toggle").attr("xlink:href","#toggleOnHor");else panel.g.select("#toggle").attr("xlink:href","#toggleOnVer");panel.g.select("#buttonPanel").classed("hidden",false)};panel.hide=function(){panel.g.select("#toggle").attr("xlink:href","#toggleOff").attr("opacity",.7).on("click",panel.show).on("mouseout",function(){d3.select(this).attr("opacity",.7)}).select("title").text("Click to show instrument panel");panel.g.select("#buttonPanel").classed("hidden",true)};panel.initDefs=function(){var defs=panel.g.append("def"),bs=panel.buttonSize-10;var d=defs.append("g").attr("id","toggleOff");d.append("rect").attr("stroke-width",2).attr("width",bs).attr("height",bs).attr("fill","#aaa").attr("stroke","#444");d.append("path").attr("d","M "+bs/2+" "+Math.floor(bs/3)+" L "+Math.ceil(bs*2/3)+" "+Math.ceil(bs*2/3)+" H "+Math.floor(bs/3)+" L "+bs/2+" "+Math.floor(bs/3)).attr("fill","#444").attr("stroke-width",0);d=defs.append("g").attr("id","toggleOnHor");d.append("rect").attr("stroke-width",2).attr("width",bs).attr("height",bs).attr("fill","#aaa").attr("stroke","#444");d.append("path").attr("d","M "+Math.floor(bs/3)+" "+bs/2+" L "+Math.ceil(bs*2/3)+" "+Math.floor(bs/3)+" V "+Math.floor(bs*2/3)+" L "+Math.floor(bs/3)+" "+bs/2).attr("fill","#444").attr("stroke-width",0);d=defs.append("g").attr("id","toggleOnVer");d.append("rect").attr("stroke-width",2).attr("width",bs).attr("height",bs).attr("fill","#aaa").attr("stroke","#444");d.append("path").attr("d","M "+bs/2+" "+Math.ceil(bs*2/3)+" L "+Math.floor(bs/3)+" "+Math.floor(bs/3)+" H "+Math.floor(bs*2/3)+" L "+bs/2+" "+Math.ceil(bs*2/3)).attr("fill","#444").attr("stroke-width",0);d=defs.append("g").attr("id","save");d.append("rect").attr("stroke-width",0).attr("width",bs).attr("height",bs).attr("fill","#444").attr("rx",bs/10).attr("ry",bs/10);d.append("path").attr("d","M "+Math.floor(4*bs/5)+" 0"+" H "+bs+" V "+Math.ceil(bs/5)+" L "+Math.floor(4*bs/5)+" 0").attr("fill","#fff").attr("stroke-width",0);d.append("rect").attr("x",Math.floor(bs/3)).attr("height",Math.floor(bs/3)).attr("width",Math.ceil(bs*2/5)).attr("fill","#fff").attr("stroke-width",0);d.append("rect").attr("x",Math.floor(44*bs/75)).attr("width",Math.ceil(2*bs/25)).attr("height",Math.ceil(bs/4)).attr("fill","#444").attr("stroke-width",0);d.append("rect").attr("x",Math.floor(bs/4)).attr("width",Math.ceil(5*bs/12)).attr("y",bs/2).attr("height",bs/2).attr("rx",bs/10).attr("ry",bs/10).attr("fill","#fff").attr("stroke-width",0);d=defs.append("g").attr("id","svg");d.append("text").attr("font-size",bs*1.5).attr("textLength",bs).attr("lengthAdjust","spacingAndGlyphs").attr("fill","#444").attr("y",bs).attr("font-weight",900).attr("font-family","Verdana").text("SVG");d=defs.append("g").attr("id","selection");d.append("rect").attr("fill-opacity",0).attr("width",Math.floor(bs*2/3)).attr("height",Math.floor(bs*2/3)).attr("x",Math.ceil(bs/3)).attr("stroke","#444").attr("stroke-width",1).attr("stroke-dasharray",2);d.append("path").attr("fill","#444").attr("stroke-width",0).attr("stroke","#444").attr("d","M "+Math.ceil(bs/3)+" "+Math.floor(bs*2/3)+" L 0 "+Math.ceil(3*bs/4)+" l "+bs/12+" "+bs/12+" L 0 "+9*bs/10+" L "+bs/10+" "+bs+" L "+11*bs/60+" "+11*bs/12+" L "+Math.floor(bs/4)+" "+bs+" L "+Math.ceil(bs/3)+" "+Math.floor(bs*2/3));d.append("circle").attr("cx",Math.floor(bs/5)).attr("cy",Math.floor(bs/5)).attr("r",2).attr("fill","#444");d.append("circle").attr("cx",Math.floor(4*bs/5)).attr("cy",Math.floor(4*bs/5)).attr("r",2).attr("fill","#444");d.append("circle").attr("cx",Math.floor(2*bs/3)).attr("cy",Math.floor(bs/3)).attr("r",3).attr("fill","#111");d=defs.append("g").attr("id","zoomIn");d.append("path").attr("fill","#444").attr("d","M "+2*bs/5+" 0"+" h "+bs/5+" v "+2*bs/5+" h "+2*bs/5+" v "+bs/5+" h -"+2*bs/5+" v "+2*bs/5+" h -"+bs/5+" v -"+2*bs/5+" h -"+2*bs/5+" v -"+bs/5+" h "+2*bs/5+" v -"+2*bs/5);d=defs.append("g").attr("id","zoomOut");d.append("rect").attr("y",3*bs/8).attr("height",bs/4).attr("width",bs).attr("fill","#444");defs.selectAll("rect").attr("transform","translate(5, 5)");defs.selectAll("path").attr("transform","translate(5, 5)");defs.selectAll("text").attr("transform","translate(5, 5)");defs.selectAll("circle").attr("transform","translate(5, 5)")};return panel}function scatterChart(id,chart){if(chart===undefined)chart=axisChart();if(id===undefined)id="layer"+chart.get_nlayers();var layer=chart.create_layer(id).get_layer(id).add_property("x").add_property("y").add_property("size",6).add_property("stroke",function(d){return d3.rgb(layer.get_colour(d)).darker(.8)}).add_property("strokeWidth",function(d){return layer.get_size(d)*.1}).add_property("symbolType","Circle").add_property("groupName",function(i){return i});chart.syncProperties(layer);layer.type="scatterChart";layer.npoints(function(){var val;for(var i=0;i<1e4;i++){try{val=layer.get_x(i)}catch(exc){return i>0?i-1:0}if(val===undefined){return i>0?i-1:0}}throw"There seem to be very many data points. Please supply a number via 'npoints'."});layer.pointMouseOver(function(d){var pos=d3.mouse(chart.container.node());d3.select(this).attr("fill",function(d){return d3.rgb(layer.get_colour(d)).darker(.5)}).classed("hover",true);layer.chart.container.select(".inform").style("left",pos[0]+10+"px").style("top",pos[1]+10+"px").select(".value").html("ID: <b>"+d+"</b>;<br>"+"x = "+layer.get_x(d).toFixed(2)+";<br>"+"y = "+layer.get_y(d).toFixed(2));layer.chart.container.select(".inform").classed("hidden",false)});layer.pointMouseOut(function(d){d3.select(this).attr("fill",function(d){return layer.get_colour(d)}).classed("hover",false);layer.chart.container.select(".inform").classed("hidden",true)});layer.findPoints=function(lu,rb){return layer.g.selectAll(".data_point").filter(function(d){var loc=[layer.chart.axes.scale_x(layer.get_x(d)),layer.chart.axes.scale_y(layer.get_y(d))];return loc[0]-layer.get_size(d)<=rb[0]&&loc[1]-layer.get_size(d)<=rb[1]&&loc[0]+layer.get_size(d)>=lu[0]&&loc[1]+layer.get_size(d)>=lu[1]}).nodes().map(function(e){return e.getAttribute("id")})};layer.layerDomainX(function(){if(layer.get_contScaleX()){return d3.extent(layer.get_dataIds(),function(k){return layer.get_x(k)})}else{return layer.get_dataIds().map(function(e){return layer.get_x(e)})}});layer.layerDomainY(function(){if(layer.get_contScaleY()){return d3.extent(layer.get_dataIds(),function(k){return layer.get_y(k)})}else{return layer.get_dataIds().map(function(e){return layer.get_y(e)})}});layer.updatePointLocation=function(){if(typeof layer.chart.transition!=="undefined"){layer.g.selectAll(".data_point").transition(layer.chart.transition).attr("transform",function(d){return"translate("+layer.chart.axes.scale_x(layer.get_x(d))+", "+layer.chart.axes.scale_y(layer.get_y(d))+")"})}else{layer.g.selectAll(".data_point").attr("transform",function(d){return"translate("+layer.chart.axes.scale_x(layer.get_x(d))+", "+layer.chart.axes.scale_y(layer.get_y(d))+")"})}return layer};layer.updateSelPointStyle=function(id){if(typeof id.length==="undefined")id=[id];if(typeof layer.chart.transition!=="undefined")for(var i=0;i<id.length;i++)layer.g.select("#p"+id[i]).transition(chart.layer.transition).attr("r",function(d){return layer.get_size(d)}).attr("fill",function(d){return layer.get_colour(d)}).attr("style",function(d){return layer.get_style(d)});else for(var i=0;i<id.length;i++)layer.g.select("#p"+id[i]).attr("r",layer.get_size(id[i])).attr("fill",layer.get_colour(id[i])).attr("style",layer.get_style(id[i]));return layer};layer.updatePointStyle=function(){layer.resetColourScale();
var ids=layer.get_dataIds();var sel=layer.g.selectAll(".data_point");if(typeof layer.chart.transition!=="undefined")sel=sel.transition(layer.chart.transition);sel.attr("d",function(d){return d3.symbol().type(d3["symbol"+layer.get_symbolType(d)]).size(get_symbolSize(layer.get_symbolType(d),layer.get_size(d)))()}).attr("fill",function(d){return layer.get_colour(d)}).attr("stroke",function(d){return layer.get_stroke(d)}).attr("stroke-width",function(d){return layer.get_strokeWidth(d)})};layer.dresser(function(sel){sel.attr("fill",function(d){return layer.get_colour(d)}).attr("r",function(d){return layer.get_size(d)})});layer.updatePoints=function(){var sel=layer.g.selectAll(".data_point").data(layer.get_dataIds(),function(d){return d});sel.exit().remove();sel.enter().append("path").attr("class","data_point").merge(sel).attr("id",function(d){return"p"+(layer.id+"_"+d).replace(/ /g,"_")}).on("click",layer.get_on_click).on("mouseover",layer.get_pointMouseOver).on("mouseout",layer.get_pointMouseOut)};return chart}function lineChart(id,chart){if(chart===undefined)chart=axisChart();if(id===undefined)id="layer"+chart.get_nlayers();var layer=chart.create_layer(id).get_layer(id).add_property("lineFun").add_property("lineStepNum",100).add_property("lineWidth",1.5).add_property("dasharray",undefined);chart.syncProperties(layer);layer.type="lineChart";layer.updatePoints=function(){var lines=layer.g.selectAll(".data_point").data(layer.get_dataIds(),function(d){return d});lines.exit().remove();lines.enter().append("path").attr("class","data_point").attr("fill","none").merge(lines).attr("id",function(d){return"p"+(layer.id+"_"+d).replace(/ /g,"_")}).on("click",layer.get_on_click).on("mouseover",layer.get_pointMouseOver).on("mouseout",layer.get_pointMouseOut)};layer.dresser(function(sel){sel.attr("stroke",function(d){return layer.get_colour(d)}).attr("stroke-width",function(d){return layer.get_lineWidth(d)}).attr("stroke-dasharray",function(d){return layer.get_dasharray(d)})});layer.updatePointLocation=function(){var lineStep=(layer.chart.axes.scale_x.domain()[1]-layer.chart.axes.scale_x.domain()[0])/layer.get_lineStepNum();var get_data=function(d){var lineData=[];for(var i=layer.chart.axes.scale_x.domain()[0];i<layer.chart.axes.scale_x.domain()[1];i+=lineStep)lineData.push({x:i,y:layer.get_lineFun(d,i)});var line=d3.line().x(function(c){return layer.chart.axes.scale_x(c.x)}).y(function(c){return layer.chart.axes.scale_y(c.y)});return line(lineData)};if(typeof layer.chart.transition!=="undefined")layer.g.selectAll(".data_point").transition(layer.chart.transition).attr("d",get_data);else layer.g.selectAll(".data_point").attr("d",get_data)};return layer}function chartBase(){var chart=base().add_property("width",500).add_property("height",500).add_property("plotWidth",440).add_property("plotHeight",440).add_property("margin",{top:15,right:10,bottom:50,left:50}).add_property("title","").add_property("titleX",function(){return chart.width()/2}).add_property("titleY",function(){return d3.min([17,chart.margin().top*.9])}).add_property("titleSize",function(){return d3.min([15,chart.margin().top*.8])}).add_property("transitionDuration",1e3).add_property("markedUpdated",function(){}).add_property("showPanel",true);chart.selectMode=false;chart.transition=undefined;chart.width("_override_","plotWidth",function(){return chart.get_width()-(chart.get_margin().right+chart.get_margin().left)});chart.margin("_override_","plotWidth",function(){return chart.get_width()-(chart.get_margin().right+chart.get_margin().left)});chart.height("_override_","plotHeight",function(){return chart.get_height()-(chart.get_margin().top+chart.get_margin().bottom)});chart.margin("_override_","plotHeight",function(){return chart.get_height()-(chart.get_margin().top+chart.get_margin().bottom)});chart.set_margin=function(margin){if(typeof margin.top==="undefined")margin.top=chart.margin().top;if(typeof margin.bottom==="undefined")margin.bottom=chart.margin().bottom;if(typeof margin.left==="undefined")margin.left=chart.margin().left;if(typeof margin.right==="undefined")margin.right=chart.margin().right;chart.margin(margin);return chart};chart.put_static_content=function(element){chart.container=element.append("div").style("position","relative");chart.container.node().ondragstart=function(){return false};chart.svg=chart.container.append("svg");chart.viewBox=chart.svg.append("defs").append("clipPath").attr("id","viewBox").append("rect");chart.container.append("div").attr("class","inform hidden").append("p").attr("class","value");chart.svg.append("text").attr("class","title plainText").attr("text-anchor","middle");chart.svg.append("g").attr("class","plotArea");if(chart.showPanel()){chart.panel=panel(chart);chart.panel.add_button("Save plot as png","#save",function(chart){function drawInlineSVG(svgElement,ctx,callback){var svgURL=(new XMLSerializer).serializeToString(svgElement);var img=new Image;img.onload=function(){ctx.drawImage(this,0,0);callback()};img.src="data:image/svg+xml; charset=utf8, "+encodeURIComponent(svgURL)}chart.svg.select(".panel_g").style("display","none");var canvas=document.createElement("canvas");canvas.height=chart.svg.attr("height");canvas.width=chart.svg.attr("width");chart.svg.selectAll("text").attr("fill","black");drawInlineSVG(chart.svg.node(),canvas.getContext("2d"),function(){var dataURL=canvas.toDataURL("image/png");var data=atob(dataURL.substring("data:image/png;base64,".length)),asArray=new Uint8Array(data.length);for(var i=0,len=data.length;i<len;++i)asArray[i]=data.charCodeAt(i);var blob=new Blob([asArray.buffer],{type:"image/png"});saveAs(blob,"export_"+Date.now()+".png")});chart.svg.select(".panel_g").style("display",undefined)});chart.panel.add_button("Save plot as svg","#svg",function(chart){chart.svg.select(".panel_g").style("display","none");var html=chart.svg.attr("xmlns","http://www.w3.org/2000/svg").node().parentNode.innerHTML;var blob=new Blob([html],{type:"image/svg+xml"});saveAs(blob,"export_"+Date.now()+".svg");chart.svg.select(".panel_g").style("display",undefined)});chart.panel.add_button("Select elements","#selection",function(chart,button){if(button.classed("clicked")){button.classed("clicked",false).attr("opacity",.6).on("mouseout",function(){d3.select(this).attr("opacity",.6)});chart.selectMode=false}else{button.classed("clicked",true).attr("opacity",1).on("mouseout",function(){});chart.selectMode=true}});chart.panel.add_button("Zoom in","#zoomIn",function(chart){});chart.panel.add_button("Zoom out","#zoomOut",function(chart){});chart.panel.put_static_content()}};chart.defineTransition=function(){chart.transition=d3.transition().duration(chart.transitionDuration());chart.transition.on("end",chart.defineTransition)};chart.mark=function(markIds){if(markIds=="__clear__"){chart.svg.selectAll(".data_point.marked").classed("marked",false);chart.svg.selectAll(".data_point").attr("opacity",1);chart.markedUpdated();return}markIds=markIds.map(function(e){return lc.escapeRegExp(e).replace(/ /g,"_")});if(markIds.length>0){var selection=chart.svg.selectAll("#"+markIds.join(", #"))}else{var selection=char.svg.select("_____")}if(chart.svg.selectAll(".data_point.marked").empty())chart.svg.selectAll(".data_point").attr("opacity",.5);selection.classed("switch",true);if(selection.size()<2)selection.filter(function(){return d3.select(this).classed("marked")}).classed("switch",false).classed("marked",false).attr("opacity",.5);selection.filter(function(){return d3.select(this).classed("switch")}).classed("marked",true).classed("switch",false).attr("opacity",1);if(chart.svg.selectAll(".data_point.marked").empty())chart.svg.selectAll(".data_point").attr("opacity",1);chart.markedUpdated()};chart.afterUpdate=function(){if(chart.get_transitionDuration()!=0)chart.defineTransition()};chart.place=function(element){if(element===undefined)element="body";if(typeof element=="string"){var node=element;element=d3.select(node);if(element.size()==0)throw"Error in function 'place': DOM selection for string '"+node+"' did not find a node."}chart.put_static_content(element);chart.update();chart.afterUpdate();return chart};chart.updateSize=function(){chart.viewBox.attr("x",-5).attr("y",-5).attr("width",chart.plotWidth()+10).attr("height",chart.plotHeight()+10);if(typeof chart.transition!=="undefined"){chart.svg.transition(chart.transition).attr("width",chart.width()).attr("height",chart.height());chart.svg.select(".title").transition(chart.transition).attr("font-size",chart.titleSize()).attr("x",chart.titleX()).attr("y",chart.titleY());chart.svg.select(".plotArea").transition(chart.transition).attr("transform","translate("+chart.margin().left+", "+chart.margin().top+")")}else{chart.svg.attr("width",chart.width()).attr("height",chart.height());chart.svg.select(".title").attr("font-size",chart.titleSize()).attr("x",chart.titleX()).attr("y",chart.titleY());chart.svg.select(".plotArea").attr("transform","translate("+chart.margin().left+", "+chart.margin().top+")")}if(chart.showPanel())chart.panel.updateSize();return chart};chart.updateTitle=function(){chart.svg.select(".title").text(chart.title())};chart.update=function(){chart.updateSize();chart.updateTitle();return chart};return chart}function layerChartBase(){var chart=chartBase().add_property("activeLayer",undefined).add_property("showLegend",true).add_property("layerIds",function(){return Object.keys(chart.layers)}).add_property("layerType",function(id){return chart.get_layer(id).type});chart.legend=legend(chart);chart.layers={};var findLayerProperty=function(propname){return function(){if(chart.get_activeLayer()[propname])return chart.get_activeLayer()[propname].apply(chart,arguments);else{for(var i in chart.layers)if(chart.layers[i][propname])return chart.layers[i][propname].apply(chart,arguments);return}}};chart.syncProperties=function(layer){for(var i=0;i<layer.propList.length;i++)if(typeof chart[layer.propList[i]]==="undefined")chart[layer.propList[i]]=findLayerProperty(layer.propList[i])};chart.get_nlayers=function(){return Object.keys(chart.layers).length};chart.get_layer=function(id){if(Object.keys(chart.layers).indexOf(id)==-1)throw"Error in 'get_layer': layer with id "+id+" is not defined";return chart.layers[id]};chart.create_layer=function(id){if(typeof id==="undefined")id="layer"+chart.get_nlayers();var layer=layerBase(id);layer.chart=chart;chart.layers[id]=layer;chart.activeLayer(chart.get_layer(id));return chart};chart.add_layer=function(id){if(typeof id==="undefined")id="layer"+chart.get_nlayers();var type;try{type=chart.get_layerType(id)}catch(exc){}if(typeof type==="undefined"){chart.create_layer(id)}else{if(type=="scatter")scatterChart(id,chart);if(type=="xLine")lineChart(id,chart)}return chart};chart.remove_layer=function(id){if(Object.keys(chart.layers).indexOf(id)==-1)return-1;for(i in chart.layers[id].legendBlocks)chart.legend.remove(i);try{chart.layers[id].g.remove()}catch(exc){}delete chart.layers[id];return 0};chart.select_layers=function(ids){if(typeof ids==="undefined")ids=chart.layerIds();var layerSelection={};layerSelection.layers={};for(var i=0;i<ids.length;i++)if(chart.layerIds().indexOf(ids[i])!=-1){if(typeof chart.layers[ids[i]]==="undefined"){chart.add_layer(ids[i]);chart.get_layer(ids[i]).put_static_content()}layerSelection.layers[ids[i]]=chart.get_layer(ids[i])}else{ids.splice(i,1);i--}if(Object.keys(layerSelection.layers).length==0){for(i in chart)layerSelection[i]=function(){return layerSelection};return layerSelection}var prop,flag,j;for(var j=0;j<ids.length;j++)for(var i=0;i<layerSelection.layers[ids[j]].propList.length;i++){prop=layerSelection.layers[ids[j]].propList[i];if(typeof layerSelection[prop]==="undefined")layerSelection[prop]=function(prop){return function(val){var vf;if(typeof val!=="function")vf=function(){return val};else vf=val;for(var i=0;i<ids.length;i++)if(typeof layerSelection.layers[ids[i]][prop]!=="undefined")layerSelection.layers[ids[i]][prop](function(id){return function(){var args=[];for(var j=0;j<arguments.length;j++)args.push(arguments[j]);args.unshift(id);return vf.apply(undefined,args)}}(ids[i]));return layerSelection}}(prop)}return layerSelection};chart.findPoints=function(lu,rb){var selPoints=[];chart.svg.selectAll(".chart_g").each(function(){selPoints=selPoints.concat(chart.get_layer(d3.select(this).attr("id")).findPoints(lu,rb))});return selPoints};chart.placeLayer=function(id){chart.get_layer(id).put_static_content();chart.get_layer(id).updateSize();chart.get_layer(id).update()};var inherited_put_static_content=chart.put_static_content;chart.put_static_content=function(element){inherited_put_static_content(element);chart.container.append("table").append("tr").append("td").node().appendChild(chart.svg.node());chart.svg=chart.container.select("svg");chart.legend.location(chart.container.select("tr").append("td").attr("id","legend"));add_click_listener(chart);for(var k in chart.layers)chart.get_layer(k).put_static_content()};var inherited_update=chart.update;chart.update=function(){var ids=chart.layerIds(),type;for(var i=0;i<ids.length;i++){if(typeof chart.layers[ids[i]]==="undefined")chart.add_layer(ids[i])}for(var k in chart.layers){if(ids.indexOf(k)==-1)chart.remove_layer(k);else{chart.get_layer(k).updatePoints();chart.get_layer(k).updatePointStyle()}}inherited_update();if(chart.showLegend()&&Object.keys(chart.legend.blocks).length>0)chart.legend.update();return chart};var inherited_afterUpdate=chart.afterUpdate;chart.afterUpdate=function(){inherited_afterUpdate();for(var k in chart.layers)chart.get_layer(k).afterUpdate()};var inherited_updateSize=chart.updateSize;chart.updateSize=function(){inherited_updateSize();for(var k in chart.layers)chart.get_layer(k).updateSize()};return chart}function axisChart(){var chart=layerChartBase();chart.add_property("singleScaleX",true).add_property("singleScaleY",true).add_property("domainX").add_property("domainY").add_property("aspectRatio",null).add_property("labelX").add_property("labelY").add_property("ticksX",undefined).add_property("ticksY",undefined);chart.axes={};var get_domain=function(axis){return function(){var domain;if(chart["get_singleScale"+axis]()){var contScale=true;for(var k in chart.layers)contScale=contScale&&chart.get_layer(k)["get_contScale"+axis]();if(contScale){for(var k in chart.layers)if(typeof chart.get_layer(k)["get_layerDomain"+axis]()!=="undefined")if(typeof domain==="undefined")domain=chart.get_layer(k)["get_layerDomain"+axis]();else{domain[0]=d3.min([domain[0],chart.get_layer(k)["get_layerDomain"+axis]()[0]]);domain[1]=d3.max([domain[1],chart.get_layer(k)["get_layerDomain"+axis]()[1]])}}else{for(var k in chart.layers)if(typeof chart.get_layer(k)["get_layerDomain"+axis]()!=="undefined")if(typeof domain==="undefined")domain=chart.get_layer(k)["get_layerDomain"+axis]();else domain=domain.concat(chart.get_layer(k)["get_layerDomain"+axis]().filter(function(e){return domain.indexOf(e)<0}))}}return domain}};chart.get_domainX=get_domain("X");chart.get_domainY=get_domain("Y");chart.domainX=function(domain){if(domain=="reset"){chart.domainX(chart.origDomainX);return chart}if(typeof domain==="function")chart.get_domainX=domain;if(domain.splice)chart.get_domainX=function(){return domain};return chart};chart.domainY=function(domain){if(domain=="reset"){chart.domainY(chart.origDomainY);return chart}if(typeof domain==="function")chart.get_domainY=domain;if(domain.splice)chart.get_domainY=function(){return domain};return chart};chart.zoom=function(lu,rb){if(lu[0]==rb[0]||lu[1]==rb[1])return;chart.domainX([chart.axes.scale_x.invert(lu[0]),chart.axes.scale_x.invert(rb[0])]);chart.domainY([chart.axes.scale_y.invert(rb[1]),chart.axes.scale_y.invert(lu[1])]);chart.updateAxes()};chart.resetDomain=function(){chart.domainX("reset");chart.domainY("reset");chart.updateAxes()};var inherited_put_static_content=chart.put_static_content;chart.put_static_content=function(element){inherited_put_static_content(element);var g=chart.svg.append("g").attr("class","axes_g");chart.axes.x_g=g.append("g").attr("class","x axis");chart.axes.x_label=chart.axes.x_g.append("text").attr("class","label").attr("y",-6).style("text-anchor","end");chart.axes.y_g=g.append("g").attr("class","y axis");chart.axes.y_label=chart.axes.y_g.append("text").attr("class","label").attr("transform","rotate(-90)").attr("y",6).attr("dy",".71em").style("text-anchor","end");var domainX=chart.get_domainX();if(domainX.length==2&&typeof domainX[0]==="number")chart.axes.scale_x=d3.scaleLinear().nice();else{chart.axes.scale_x=d3.scalePoint().padding(.3)}chart.origDomainX=chart.get_domainX;var domainY=chart.get_domainY();if(domainY.length==2&&typeof domainY[0]==="number")chart.axes.scale_y=d3.scaleLinear().nice();else chart.axes.scale_y=d3.scalePoint().padding(.3);chart.origDomainY=chart.get_domainY};var inherited_updateSize=chart.updateSize;chart.updateSize=function(){inherited_updateSize();if(typeof chart.transition!=="undefined"){chart.svg.select(".axes_g").transition(chart.transition).attr("transform","translate("+chart.get_margin().left+", "+chart.get_margin().top+")");chart.axes.x_g.transition(chart.transition).attr("transform","translate(0,"+chart.get_plotHeight()+")");chart.axes.x_label.transition(chart.transition).attr("x",chart.get_plotWidth())}else{chart.svg.select(".axes_g").attr("transform","translate("+chart.get_margin().left+", "+chart.get_margin().top+")");chart.axes.x_g.attr("transform","translate(0,"+chart.get_plotHeight()+")");chart.axes.x_label.attr("x",chart.get_plotWidth())}chart.axes.scale_x.range([0,chart.get_plotWidth()]);chart.axes.scale_y.range([chart.get_plotHeight(),0]);chart.updateAxes();return chart};function fix_aspect_ratio(scaleX,scaleY,asp){var xfactor=(scaleX.range()[1]-scaleX.range()[0])/(scaleX.domain()[1]-scaleX.domain()[0]);var yfactor=(scaleY.range()[1]-scaleY.range()[0])/(scaleY.domain()[1]-scaleY.domain()[0]);var curasp=Math.abs(xfactor/yfactor);if(curasp>asp){var cur_dom_length=scaleX.domain()[1]-scaleX.domain()[0];var extension=cur_dom_length*(curasp/asp-1)/2;scaleX.domain([scaleX.domain()[0]-extension,scaleX.domain()[1]+extension])}else{var cur_dom_length=scaleY.domain()[1]-scaleY.domain()[0];var extension=cur_dom_length*(asp/curasp-1)/2;scaleY.domain([scaleY.domain()[0]-extension,scaleY.domain()[1]+extension])}}var get_ticks=function(axis){var ticks={tickValues:null,tickFormat:null},tickArray=chart["ticks"+axis]();if(tickArray){if(typeof tickArray.splice==="undefined")throw"Error in 'get_ticks': new tick values and labels should be passed "+"as an array";if(typeof tickArray[0].splice==="undefined")tickArray=[tickArray];for(var i=1;i<tickArray.length;i++)if(tickArray[0].length!=tickArray[i].length)throw"Error in 'get_ticks': the amount of tick labels must be equal to the "+"amount of tick values";ticks.tickValues=tickArray[0];if(tickArray.length==1)return ticks;var ident=tickArray.length>2,j=1,i;while(ident&&j<tickArray.length-1){i=0;while(ident&&i<tickArray[j].length){ident=tickArray[j][i]==tickArray[j+1][i];i++}j++}if(ident)tickArray.splice(2);var tickLabels=[],value;if(tickArray.length>2){for(var i=0;i<tickArray[0].length;i++){value="";for(var j=1;j<tickArray.length;j++){value+="<tspan x = 0.5 dy = "+1.1+"em";if(tickArray.colour)value+=" fill = '"+tickArray.colour[j-1]+"'>";else value+=">";value+=tickArray[j][i]+"</tspan>"}tickLabels.push(value)}}else{tickLabels=tickArray[1]}ticks.tickFormat=function(d){return tickLabels[ticks.tickValues.indexOf(d)]}}return ticks};chart.updateAxes=function(){chart.axes.x_label.text(chart.get_labelX());chart.axes.y_label.text(chart.get_labelY());chart.axes.scale_x.domain(chart.get_domainX());chart.axes.scale_y.domain(chart.get_domainY());if(chart.aspectRatio())fix_aspect_ratio(chart.axes.scale_x,chart.axes.scale_y,chart.get_aspectRatio());var ticksX=get_ticks("X"),ticksY=get_ticks("Y");if(typeof chart.transition!=="undefined"){d3.axisBottom().scale(chart.axes.scale_x).tickValues(ticksX.tickValues).tickFormat(ticksX.tickFormat)(chart.axes.x_g.transition(chart.transition));d3.axisLeft().scale(chart.axes.scale_y).tickValues(ticksY.tickValues).tickFormat(ticksY.tickFormat)(chart.axes.y_g.transition(chart.transition))}else{d3.axisBottom().tickValues(ticksX.tickValues).tickFormat(ticksX.tickFormat).scale(chart.axes.scale_x)(chart.axes.x_g);d3.axisLeft().scale(chart.axes.scale_y).tickValues(ticksY.tickValues).tickFormat(ticksY.tickFormat)(chart.axes.y_g)}var updateX=function(){chart.axes.x_g.selectAll(".tick").selectAll("text").html(ticksX.tickFormat)};if(ticksX.tickFormat)if(chart.transition)setTimeout(updateX,chart.transition.duration());else updateX();var updateY=function(){chart.axes.y_g.selectAll(".tick").selectAll("text").html(ticksX.tickFormat)};if(ticksY.tickFormat)if(chart.transition)setTimeout(updateY,chart.transition.duration());else updateY();for(var k in chart.layers)chart.get_layer(k).updatePointLocation();return chart};return chart}function heatmapChart(id,chart){var chart=chartBase().add_property("nrows").add_property("ncols");chart.add_property("colLabels",function(i){return i}).add_property("rowLabels",function(i){return i}).add_property("colIds",function(){return undefined}).add_property("rowIds",function(){return undefined}).add_property("dispColIds",function(){return chart.get_colIds()}).add_property("dispRowIds",function(){return chart.get_rowIds()}).add_property("heatmapRow",function(rowId){return chart.get_dispRowIds().indexOf(rowId)}).add_property("heatmapCol",function(colId){return chart.get_dispColIds().indexOf(colId)}).add_property("value").add_property("mode","default").add_property("colour",function(val){return chart.colourScale(val)}).add_property("palette",d3.interpolateOrRd).add_property("colourRange",function(){return chart.dataRange()}).add_property("clusterRowMetric",getEuclideanDistance).add_property("clusterColMetric",getEuclideanDistance).add_property("on_click",function(){}).add_property("rowTitle","").add_property("showValue",false).add_property("colTitle","").add_property("showLegend",true).add_property("informText",function(rowId,colId){return"Row: <b>"+rowId+"</b>;<br>"+"Col: <b>"+colId+"</b>;<br>"+"value = "+chart.get_value(rowId,colId).toFixed(2)});chart.margin({top:100,left:100,right:10,bottom:40});chart.ncols("_override_","colIds",function(){return d3.range(chart.get_ncols())});chart.nrows("_override_","rowIds",function(){return d3.range(chart.get_nrows())});chart.rowIds("_override_","nrows",function(){return chart.get_rowIds().length});chart.colIds("_override_","ncols",function(){return chart.get_colIds().length});chart.dispRowIds("_override_","nrows",function(){return chart.get_dispRowIds().length});chart.dispColIds("_override_","ncols",function(){return chart.get_dispColIds().length});chart.axes={};var inherited_put_static_content=chart.put_static_content;chart.put_static_content=function(element){inherited_put_static_content(element);add_click_listener(chart);chart.svg.append("g").attr("class","row label_panel");chart.svg.append("g").attr("class","col label_panel");chart.canvas=chart.container.append("canvas").style("position","absolute").style("z-index",-5);chart.g=chart.svg.select(".plotArea").append("g").attr("class","chart_g").attr("clip-path","url(#viewBox)");chart.text=chart.g.append("g").attr("class","text_g");chart.axes.x_label=chart.svg.append("text").attr("class","axisLabel").attr("text-anchor","end");chart.axes.y_label=chart.svg.append("text").attr("class","axisLabel").attr("text-anchor","end").attr("transform","rotate(-90)");chart.svg.append("g").attr("class","legend_panel");get_mode()=="svg"?chart.g.classed("active",true):chart.canvas.classed("active",true)};var get_mode=function(){if(chart.mode()=="default")return chart.ncols()*chart.nrows()>5e3?"canvas":"svg";return chart.mode()};chart.findPoints=function(lu,rb){var selectedIds=[];if(get_mode()=="svg"){var selectedPoints=chart.g.selectAll(".data_point").filter(function(){var loc=[this.x.baseVal.value,this.y.baseVal.value];return loc[0]<=rb[0]&&loc[1]<=rb[1]&&loc[0]+chart.cellSize.width>=lu[0]&&loc[1]+chart.cellSize.height>=lu[1]});selectedIds=selectedPoints.data().map(function(e){return"p"+e[0]+"_-sep-_"+e[1]})}else{var selCols=chart.svg.select(".col").selectAll(".label").filter(function(){var loc=this.y.baseVal[0].value;return loc>=lu[0]&&loc<=rb[0]+chart.cellSize.width}).data(),selRows=chart.svg.select(".row").selectAll(".label").filter(function(){var loc=this.y.baseVal[0].value;return loc>=lu[1]&&loc<=rb[1]+chart.cellSize.height}).data();for(var i=0;i<selRows.length;i++)for(var j=0;j<selCols.length;j++)selectedIds.push("p"+selRows[i]+"_-sep-_"+selCols[j])}return selectedIds};chart.dataRange=function(){var i=0,range,newRange,rowIds=chart.get_rowIds(),colIds=chart.get_colIds();do{newRange=d3.extent(colIds,function(col){return chart.get_value(rowIds[i],col)});if(typeof range==="undefined")range=newRange;if(newRange[0]<range[0])range[0]=newRange[0];if(newRange[1]>range[1])range[1]=newRange[1];i++}while(i<chart.get_nrows());return range};chart.labelMouseOver=function(){d3.select(this).classed("hover",true)};chart.labelMouseOut=function(){d3.select(this).classed("hover",false)};chart.reorderRow=function(f){if(f=="flip"){chart.get_heatmapRow("__flip__");chart.updateLabelPosition();return chart}chart.svg.select(".col").selectAll(".label").classed("selected",false).classed("sorted",false);var ids=chart.get_rowIds().slice(),ind;ids=ids.sort(f);chart.heatmapRow(function(rowId){if(rowId=="__flip__"){ids=ids.reverse();return}if(rowId=="__order__")return ids.sort(f);var actIds=chart.get_dispRowIds(),orderedIds=ids.filter(function(e){return actIds.indexOf(e)!=-1});if(orderedIds.length!=actIds.length){orderedIds=actIds.sort(f);ids=orderedIds.slice()}ind=orderedIds.indexOf(rowId);if(ind>-1)return ind;else throw"Wrong rowId in chart.get_heatmapRow"});chart.updateLabelPosition();return chart};chart.reorderCol=function(f){if(f=="flip"){chart.get_heatmapCol("__flip__");chart.updateLabelPosition();return chart}chart.svg.select(".row").selectAll(".label").classed("selected",false).classed("sorted",false);var ids=chart.get_colIds().slice(),ind;ids=ids.sort(f);chart.heatmapCol(function(colId){if(colId=="__flip__"){ids=ids.reverse();return}if(colId=="__order__")return ids.sort(f);var actIds=chart.get_dispColIds(),orderedIds=ids.filter(function(e){return actIds.indexOf(e)!=-1});if(orderedIds.length!=actIds.length){orderedIds=actIds.sort(f);ids=orderedIds.slice()}ind=orderedIds.indexOf(colId);if(ind>-1)return ind;else throw"Wrong rowId in chart.get_heatmapRow"});chart.updateLabelPosition();return chart};var inherited_updateSize=chart.updateSize;chart.updateSize=function(){inherited_updateSize();if(typeof chart.transition!=="undefined"){chart.svg.selectAll(".label_panel").transition(chart.transition).attr("transform","translate("+chart.get_margin().left+", "+chart.get_margin().top+")");chart.svg.select(".legend_panel").transition(chart.transition).attr("transform","translate(0, "+(chart.get_margin().top+chart.get_plotHeight())+")");chart.axes.x_label.transition(chart.transition).attr("font-size",d3.min([chart.get_margin().bottom-2,15])).attr("x",chart.get_plotWidth()+chart.get_margin().left).attr("y",chart.get_height());chart.axes.y_label.transition(chart.transition).attr("font-size",d3.min([chart.get_margin().right-2,15])).attr("x",-chart.get_margin().top).attr("y",chart.get_width());chart.canvas.transition(chart.transition).style("left",chart.margin().left).style("top",chart.margin().top).attr("width",chart.plotWidth()).attr("height",chart.plotHeight())}else{chart.svg.selectAll(".label_panel").attr("transform","translate("+chart.get_margin().left+", "+chart.get_margin().top+")");chart.svg.select(".legend_panel").attr("transform","translate(0, "+(chart.get_margin().top+chart.get_plotHeight())+")");chart.axes.x_label.attr("font-size",d3.min([chart.get_margin().bottom-2,15])).attr("x",chart.get_plotWidth()+chart.get_margin().left).attr("y",chart.get_height());chart.axes.y_label.attr("font-size",d3.min([chart.get_margin().right-2,15])).attr("x",-chart.get_margin().top).attr("y",chart.get_width());chart.canvas.style("left",chart.margin().left).style("top",chart.margin().top).attr("width",chart.plotWidth()).attr("height",chart.plotHeight())}chart.updateLegendSize();chart.updateLabelPosition();return chart};chart.updateLabelPosition=function(){var ncols=chart.get_dispColIds().length,nrows=chart.get_dispRowIds().length;chart.cellSize={width:chart.get_plotWidth()/ncols,height:chart.get_plotHeight()/nrows};chart.axes.scale_x=d3.scaleLinear().domain([0,ncols-1]).range([0,chart.get_plotWidth()-chart.cellSize.width]).nice();chart.axes.scale_y=d3.scaleLinear().domain([0,nrows-1]).range([0,chart.get_plotHeight()-chart.cellSize.height]).nice();if(typeof chart.transition!=="undefined"){chart.svg.select(".col").selectAll(".label").transition(chart.transition).attr("font-size",d3.min([chart.cellSize.width,12])).attr("y",function(d){return chart.axes.scale_x(chart.get_heatmapCol(d)+1)});chart.svg.select(".row").selectAll(".label").transition(chart.transition).attr("font-size",d3.min([chart.cellSize.height,12])).attr("y",function(d){return chart.axes.scale_y(chart.get_heatmapRow(d)+1)})}else{chart.svg.select(".col").selectAll(".label").attr("font-size",d3.min([chart.cellSize.width,12])).attr("y",function(d){return chart.axes.scale_x(chart.get_heatmapCol(d)+1)});chart.svg.select(".row").selectAll(".label").attr("font-size",d3.min([chart.cellSize.height,12])).attr("y",function(d){return chart.axes.scale_y(chart.get_heatmapRow(d)+1)})}chart.updateCellPosition();return chart};chart.updateLabels=function(){var colLabels=chart.svg.select(".col").selectAll(".label").data(chart.get_dispColIds(),function(d){return d});colLabels.exit().remove();var rowLabels=chart.svg.select(".row").selectAll(".label").data(chart.get_dispRowIds(),function(d){return d});rowLabels.exit().remove();colLabels.enter().append("text").attr("class","label").attr("transform","rotate(-90)").style("text-anchor","start").attr("dx",2).merge(colLabels).attr("id",function(d){return d.replace(/ /g,"_")}).on("mouseover",chart.labelMouseOver).on("mouseout",chart.labelMouseOut).on("click",chart.labelClick);rowLabels.enter().append("text").attr("class","label").style("text-anchor","end").attr("dx",-2).merge(rowLabels).attr("id",function(d){return d.replace(/ /g,"_")}).on("mouseover",chart.labelMouseOver).on("mouseout",chart.labelMouseOut).on("click",chart.labelClick);chart.updateCells();return chart};chart.updateLabelText=function(){if(typeof chart.transition!=="undefined"){chart.svg.select(".col").selectAll(".label").transition(chart.transition).text(function(d){return chart.get_colLabels(d)});chart.svg.select(".row").selectAll(".label").transition(chart.transition).text(function(d){return chart.get_rowLabels(d)})}else{chart.svg.select(".col").selectAll(".label").text(function(d){return chart.get_colLabels(d)});chart.svg.select(".row").selectAll(".label").text(function(d){return chart.get_rowLabels(d)})}return chart};chart.zoom=function(lu,rb){var selectedCells=chart.findPoints(lu,rb);if(selectedCells.length<2)return;var rowIdsAll=[],colIdsAll=[];selectedCells.map(function(e){rowIdsAll.push(e.substr(1).split("_-sep-_")[0]);colIdsAll.push(e.substr(1).split("_-sep-_")[1])});var rowIds=[],colIds=[];for(var i=0;i<rowIdsAll.length;i++)if(rowIds.indexOf(rowIdsAll[i])==-1)rowIds.push(rowIdsAll[i]);for(var i=0;i<colIdsAll.length;i++)if(colIds.indexOf(colIdsAll[i])==-1)colIds.push(colIdsAll[i]);if(rowIds.length>0)chart.dispRowIds(rowIds);chart.dispColIds(colIds);chart.updateLabels();chart.updateLabelPosition();return chart};chart.resetDomain=function(){chart.dispColIds(chart.get_colIds);chart.dispRowIds(chart.get_rowIds);chart.updateLabels().updateLabelPosition().updateCellColour().updateLabelText();return chart};chart.resetColourScale=function(){var range=chart.get_colourRange();chart.colourScale=d3.scaleSequential(chart.get_palette).domain(range);if(chart.get_showLegend())chart.updateLegend()};chart.pointMouseOver=function(d){var pos=d3.mouse(chart.container.node());
d3.select(this).attr("fill",function(d){return d3.rgb(chart.get_colour(chart.get_value(d[0],d[1]))).darker(.5)}).classed("hover",true);chart.svg.select(".col").selectAll(".label").filter(function(dl){return dl==d[1]}).classed("hover",true);chart.svg.select(".row").selectAll(".label").filter(function(dl){return dl==d[0]}).classed("hover",true);if(chart.get_showValue()){chart.g.selectAll(".tval").filter(function(fd){return fd[0]==d[0]&&fd[1]==d[1]}).classed("hidden",false)}else{chart.container.select(".inform").style("left",pos[0]+10+"px").style("top",pos[1]+10+"px").select(".value").html(function(){return chart.get_informText(d[0],d[1])});chart.container.select(".inform").classed("hidden",false)}};chart.pointMouseOut=function(d){d3.select(this).attr("fill",function(d){return chart.get_colour(chart.get_value(d[0],d[1]))}).classed("hover",false);chart.svg.selectAll(".label").classed("hover",false);if(chart.get_showValue()){chart.g.selectAll(".tval").classed("hidden",true)}else{chart.container.select(".inform").classed("hidden",true)}};chart.labelClick=function(d){var type;d3.select(this.parentNode).classed("row")?type="row":type="col";if(d3.select(this).classed("sorted")){type=="col"?chart.reorderRow("flip"):chart.reorderCol("flip")}else{if(type=="col")chart.reorderRow(function(a,b){return chart.get_value(b,d)-chart.get_value(a,d)});else chart.reorderCol(function(a,b){return chart.get_value(d,b)-chart.get_value(d,a)})}d3.select(this).classed("sorted",true);chart.svg.selectAll(".sorted").classed("selected",true)};chart.updateCellColour=function(){if(!chart.checkMode())return chart;if(get_mode()=="svg"){if(typeof chart.transition!=="undefined")chart.g.selectAll(".data_point").transition(chart.transition).attr("fill",function(d){return chart.get_colour(chart.get_value(d[0],d[1]))});else chart.g.selectAll(".data_point").attr("fill",function(d){return chart.get_colour(chart.get_value(d[0],d[1]))});chart.svg.selectAll(".sorted").classed("selected",false).classed("sorted",false);if(chart.get_showValue())chart.updateTextValues()}else{if(!chart.updateStarted)chart.updateCanvas()}return chart};chart.updateCells=function(){if(!chart.checkMode())return chart;var markedCells=chart.g.selectAll(".marked").size();if(get_mode()=="svg"){var rows=chart.g.selectAll(".data_row").data(chart.get_dispRowIds(),function(d){return d});rows.exit().remove();rows.enter().append("g").attr("class","data_row");var cells=chart.g.selectAll(".data_row").selectAll(".data_point").data(function(d){return chart.get_dispColIds().map(function(e){return[d,e]})},function(d){return d});cells.exit().remove();cells.enter().append("rect").attr("class","data_point").attr("opacity",.5).merge(cells).attr("id",function(d){return"p"+(d[0]+"_-sep-_"+d[1]).replace(/ /g,"_")}).attr("rowId",function(d){return d[0]}).attr("colId",function(d){return d[1]}).on("mouseover",chart.pointMouseOver).on("mouseout",chart.pointMouseOut).on("click",function(d){chart.get_on_click.apply(this,[d[0],d[1]])});if(chart.get_showValue())chart.updateTexts()}else{chart.updateCanvas()}var newMarked=chart.g.selectAll(".marked");if(markedCells>newMarked.size())chart.markedUpdated();if(newMarked.size()==0)chart.g.selectAll(".data_point").attr("opacity",1);return chart};chart.updateCellPosition=function(){if(!chart.checkMode())return chart;if(get_mode()=="svg"){if(typeof chart.transition!=="undefined")chart.g.selectAll(".data_point").transition(chart.transition).attr("x",function(d){return chart.axes.scale_x(chart.get_heatmapCol(d[1]))}).attr("width",chart.cellSize.width).attr("height",chart.cellSize.height).attr("y",function(d){return chart.axes.scale_y(chart.get_heatmapRow(d[0]))});else chart.g.selectAll(".data_point").attr("x",function(d){return chart.axes.scale_x(chart.get_heatmapCol(d[1]))}).attr("width",chart.cellSize.width).attr("height",chart.cellSize.height).attr("y",function(d){return chart.axes.scale_y(chart.get_heatmapRow(d[0]))});if(chart.get_showValue())chart.updateTextPosition()}else{chart.updateCanvas()}return chart};chart.cluster=function(type){if(type!="Row"&&type!="Col")throw"Error in 'cluster': type "+type+" cannot be recognised. "+"Please, use either 'Row' or 'Col'";var items={},it=[],aIds=chart["get_disp"+type+"Ids"](),bIds;type=="Row"?bIds=chart.get_dispColIds():bIds=chart.get_dispRowIds();for(var i=0;i<aIds.length;i++){for(var j=0;j<bIds.length;j++)type=="Row"?it.push(chart.get_value(aIds[i],bIds[j])):it.push(chart.get_value(bIds[j],aIds[i]));items[aIds[i]]=it.slice();it=[]}var getDistance=function(a,b){return chart["get_cluster"+type+"Metric"](items[a],items[b])};var newOrder=[];var traverse=function(node){if(node.value){newOrder.push(node.value);return}traverse(node.left);traverse(node.right)};var clusters=clusterfck.hcluster(aIds,getDistance,clusterfck.COMPLETE_LINKAGE);traverse(clusters);var oldOrder=chart["get_heatmap"+type]("__order__");chart["reorder"+type](function(a,b){if(newOrder.indexOf(a)!=-1&&newOrder.indexOf(b)!=-1)return newOrder.indexOf(a)-newOrder.indexOf(b);return oldOrder.indexOf(a)-oldOrder.indexOf(b)});chart.updateLabelPosition();return chart};chart.updateTexts=function(){var rows=chart.g.selectAll(".text_row").data(chart.get_dispRowIds(),function(d){return d});rows.exit().remove();rows.enter().append("g").attr("class","text_row");var text=chart.g.selectAll(".text_row").selectAll(".tval").data(function(d){return chart.get_dispColIds().map(function(e){return[d,e]})},function(d){return d});text.exit().remove();text.enter().append("text").attr("class","tval hidden");return chart};chart.updateTextPosition=function(){if(typeof chart.transition!=="undefined")chart.g.selectAll(".tval").transition(chart.transition).attr("x",function(d){return chart.axes.scale_x(chart.get_heatmapCol(d[1]))}).attr("font-size",chart.cellSize.height*.5).attr("y",function(d){return chart.axes.scale_y(chart.get_heatmapRow(d[0]))+chart.cellSize.height*.75});else chart.g.selectAll(".tval").attr("x",function(d){return chart.axes.scale_x(chart.get_heatmapCol(d[1]))}).attr("font-size",chart.cellSize.height*.5).attr("y",function(d){return chart.axes.scale_y(chart.get_heatmapRow(d[0]))+chart.cellSize.height*.75});return chart};chart.updateTextValues=function(){if(typeof chart.transition!=="undefined")chart.g.selectAll(".tval").transition(chart.transition).text(function(d){return chart.get_value(d[0],d[1]).toFixed(1)});else chart.g.selectAll(".tval").text(function(d){return chart.get_value(d[0],d[1]).toFixed(1)});return chart};chart.updateLegendSize=function(){var height=d3.min([chart.get_margin().bottom*.5,20]),width=d3.min([chart.get_width()/23,30]),fontSize=d3.min([chart.get_margin().bottom*.3,width/2,15]),blocks=chart.svg.select(".legend_panel").selectAll(".legend_block").attr("transform",function(d){return"translate("+(d+1)*width+", 0)"});blocks.selectAll("text").attr("font-size",fontSize).attr("dy",chart.get_margin().bottom*.4).attr("dx",width);blocks.selectAll("rect").attr("height",height).attr("width",width).attr("y",chart.get_margin().bottom*.5)};chart.updateLegend=function(){var range=chart.get_colourRange(),step=(range[1]-range[0])/20,blocks=chart.svg.select(".legend_panel").selectAll(".legend_block").data(d3.range(21)).enter().append("g").attr("class","legend_block");blocks.append("text").attr("text-anchor","end");blocks.append("rect");chart.svg.select(".legend_panel").selectAll(".legend_block").selectAll("text").text(function(d){if(d%2==0)return(range[0]+step*d).toFixed(2);else return""});chart.svg.select(".legend_panel").selectAll(".legend_block").selectAll("rect").attr("fill",function(d){return chart.colourScale(range[0]+step*d)})};chart.checkMode=function(){if(get_mode()=="svg"&&chart.canvas.classed("active")){chart.canvas.classed("active",false);chart.g.classed("active",true);chart.canvas.node().getContext("2d").clearRect(0,0,chart.plotWidth(),chart.plotHeight());add_click_listener(chart);if(chart.updateStarted)return true;else{chart.update();return false}}if(get_mode()=="canvas"&&chart.g.classed("active")){chart.canvas.classed("active",true);chart.g.classed("active",false);while(chart.g.node().firstChild)chart.g.node().removeChild(chart.g.node().firstChild)}return true};chart.updateCanvas=function(){var ctx=chart.canvas.node().getContext("2d");var ncols=chart.ncols(),nrows=chart.nrows(),rowIds=chart.dispRowIds(),colIds=chart.dispColIds();var pixelHeatmap=document.createElement("canvas");pixelHeatmap.width=ncols;pixelHeatmap.height=nrows;var rgbColour,position;var pixelData=new ImageData(ncols,nrows);for(var i=0;i<nrows;i++)for(var j=0;j<ncols;j++){rgbColour=d3.rgb(chart.get_colour(chart.get_value(rowIds[i],colIds[j])));position=chart.get_heatmapRow(rowIds[i])*ncols*4+chart.get_heatmapCol(colIds[j])*4;pixelData.data[position]=rgbColour.r;pixelData.data[position+1]=rgbColour.g;pixelData.data[position+2]=rgbColour.b}for(var i=0;i<ncols*nrows;i++)pixelData.data[i*4+3]=255;pixelHeatmap.getContext("2d").putImageData(pixelData,0,0);ctx.imageSmoothingEnabled=false;ctx.drawImage(pixelHeatmap,0,0,ncols,nrows,0,0,chart.width(),chart.height())};chart.update=function(){chart.updateTitle();chart.resetColourScale();chart.axes.x_label.text(chart.get_colTitle());chart.axes.y_label.text(chart.get_rowTitle());chart.updateStarted=true;chart.updateLabels().updateSize().updateLabelText().updateCellColour();chart.updateStarted=false;return chart};return chart}function sigmoid(x,midpoint,slope){return 1/(1+Math.exp(-slope*(x-midpoint)))}function make_stretched_sigmoid(midpoint,slope,xl,xr){var yl=sigmoid(xl,midpoint,slope,0,1);var yr=sigmoid(xr,midpoint,slope,0,1);var ym=Math.min(yl,yr);return function(x){return(sigmoid(x,midpoint,slope,1)-ym)/Math.abs(yr-yl)}}function sigmoidColorSlider(){var obj=chartBase().add_property("straightColorScale").add_property("midpoint",undefined).add_property("slopewidth",undefined).add_property("on_drag",function(){}).add_property("on_change",function(){}).margin({top:20,right:10,bottom:5,left:10}).height(80).transitionDuration(0);obj.showPanel(false);obj.straightColorScale(d3.scaleLinear().range(["white","darkblue"]));obj.clamp_markers=function(){var min=d3.min(obj.get_straightColorScale.domain());var max=d3.max(obj.get_straightColorScale.domain());if(obj.get_midpoint()<min)obj.midpoint(min);if(obj.get_midpoint()>max)obj.midpoint(max);if(obj.get_slopewidth()>max-min)obj.slopewidth(max-min);if(obj.get_slopewidth()<min-max)obj.slopewidth(min-max)};var inherited_put_static_content=obj.put_static_content;obj.put_static_content=function(element){inherited_put_static_content(element);var g=obj.svg.append("g").attr("class","sigmoidColorSlider").attr("transform","translate("+obj.get_margin().left+", "+obj.get_margin().top+")");obj.axis=g.append("g").attr("class","axis");var defs=g.append("defs");obj.gradient=defs.append("linearGradient").attr("id","scaleGradient").attr("x1","0%").attr("y1","0%").attr("x2","100%").attr("y2","0%");obj.gradient.selectAll("stop").data(d3.range(100)).enter().append("stop").attr("offset",function(d){return d+"%"});obj.colorBar=g.append("rect").attr("x","0").attr("y","5").attr("height",20).attr("fill","url(#scaleGradient)").style("stroke","black").style("stroke-width","1");defs.append("path").attr("id","mainMarker").attr("d","M 0 0 L 8 5 L 8 25 L -8 25 L -8 5 Z").style("fill","gray").style("stroke","black");defs.append("path").attr("id","rightMarker").attr("d","M 0 0 L 5 5 L 5 15 L 0 15 Z").style("fill","lightgray").style("stroke","black");defs.append("path").attr("id","leftMarker").attr("d","M 0 0 L -5 5 L -5 15 L 0 15 Z").style("fill","lightgray").style("stroke","black");obj.mainMarker=g.append("use").attr("xlink:href","#mainMarker").attr("y",28).call(d3.drag().on("drag",function(){obj.midpoint(obj.pos_scale.invert(obj.pos_scale(obj.get_midpoint())+d3.event.dx));obj.clamp_markers();obj.get_on_drag();obj.update()}).on("end",function(){obj.get_on_change()}));obj.rightMarker=g.append("use").attr("xlink:href","#rightMarker").attr("y",30).call(d3.drag().on("drag",function(){obj.slopewidth(obj.pos_scale.invert(obj.pos_scale(obj.get_slopewidth())+d3.event.dx));obj.clamp_markers();obj.update();obj.get_on_drag()}).on("end",function(){obj.get_on_change()}));obj.leftMarker=g.append("use").attr("xlink:href","#leftMarker").attr("y",30).call(d3.drag().on("drag",function(){obj.slopewidth(obj.pos_scale.invert(obj.pos_scale(obj.get_slopewidth())-d3.event.dx));obj.clamp_markers();obj.update();obj.get_on_drag()}).on("end",function(){obj.get_on_change()}))};var inherited_update=obj.update;obj.update=function(){inherited_update();var percent_scale=d3.scaleLinear().domain([0,100]).range(obj.get_straightColorScale.domain());if(obj.get_midpoint()==undefined)obj.midpoint(percent_scale(50));if(obj.get_slopewidth()==undefined)obj.slopewidth(Math.abs(percent_scale(15)));obj.pos_scale=d3.scaleLinear().range([0,obj.get_plotWidth()]).domain(obj.get_straightColorScale.domain());d3.axisTop().scale(obj.pos_scale)(obj.axis);obj.colorBar.attr("width",obj.get_plotWidth());obj.the_sigmoid=make_stretched_sigmoid(obj.get_midpoint(),1.38/obj.get_slopewidth(),obj.get_straightColorScale.domain()[0],obj.get_straightColorScale.domain()[1]);obj.gradient.selectAll("stop").data(d3.range(100)).style("stop-color",function(d){return obj.get_straightColorScale(percent_scale(100*obj.the_sigmoid(percent_scale(d))))});obj.colourScale=function(val){return obj.get_straightColorScale(percent_scale(100*obj.the_sigmoid(val)))};obj.mainMarker.attr("x",obj.pos_scale(obj.get_midpoint()));obj.rightMarker.attr("x",obj.pos_scale(obj.get_midpoint()+obj.get_slopewidth()));obj.leftMarker.attr("x",obj.pos_scale(obj.get_midpoint()-obj.get_slopewidth()))};return obj}function simpleTable(){var chart=chartBase().add_property("record",{});var inherited_put_static_content=chart.put_static_content;chart.put_static_content=function(element){inherited_put_static_content(element);chart.table=chart.container.append("table").attr("border",1)};var inherited_update=chart.update;chart.update=function(){inherited_update();var sel=chart.table.selectAll("tr").data(Object.keys(obj.get_record()));sel.exit().remove();sel.enter().append("tr").merge(sel).html(function(k){return"<td>"+k+"</td><td>"+chart.get_record()[k]+"</td>"});return chart};return chart}exports.base=base;exports.layerBase=layerBase;exports.chartBase=chartBase;exports.axisChart=axisChart;exports.scatterChart=scatterChart;exports.lineChart=lineChart;exports.heatmapChart=heatmapChart;exports.cache=cache;exports.separateBy=separateBy;exports.getEuclideanDistance=getEuclideanDistance;exports.add_click_listener=add_click_listener;exports.pearsonCorr=pearsonCorr;exports.fillTextBlock=fillTextBlock;exports.get_symbolSize=get_symbolSize;exports.escapeRegExp=escapeRegExp;exports.sigmoidColorSlider=sigmoidColorSlider;exports.simpleTable=simpleTable;Object.defineProperty(exports,"__esModule",{value:true})});